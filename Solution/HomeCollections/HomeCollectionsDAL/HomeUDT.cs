...
namespace HomeCollectionsDAL
{
    public class HomeUDT
    {
        ...
        public static System.Data.DataTable ConvertToUDTHCBookingData(List<HCBookingData> _lstCollection)
        {
	 ...
	 //lan
		...
		_datatable.Columns.Add("OrgName", typeof(System.String));
        _datatable.Columns.Add("OrgLocation", typeof(System.String));
        _datatable.Columns.Add("BookingDate", typeof(System.DateTime));
        _datatable.Columns.Add("PatientNumber", typeof(System.String));
        ...
        _datatable.Columns.Add("CollectionAddress", typeof(System.String));
        _datatable.Columns.Add("CollectionDate", typeof(System.String));
        _datatable.Columns.Add("Technician", typeof(System.String));
		_datatable.Columns.Add("TestCodes", typeof(System.String));
        _datatable.Columns.Add("Discount", typeof(System.String));		
		...
		_datatable.Columns.Add("RefDr", typeof(System.String));
		_datatable.Columns.Add("Remarks", typeof(System.String));		
	
		 DataRow _datarow ;
	
		 foreach (HCBookingData _list in _lstCollection)
			{
			   _datarow = _datatable.NewRow();
			   _datarow["SlNo"]=_list.SlNo;
			   _datarow["OrgName"]=_list.OrgName;
               _datarow["OrgLocation"] = _list.OrgLocation;
               _datarow["BookingDate"] = Convert.ToDateTime(_list.BookingDate);
               _datarow["PatientNumber"] = _list.PatientNumber;
               ...
               _datarow["CollectionAddress"] = _list.CollectionAddress;
               _datarow["CollectionDate"] = _list.CollectionDate;
               _datarow["Technician"] = _list.Technician;              
               _datarow["TestCodes"] = _list.TestCodes;
               ...
               _datarow["RefDr"] = _list.RefDocName;
	 ...
	 //Test
        ...
        public static System.Data.DataTable ConvertToSaveUDTHCBookingData(List<HCBookingData> _lstCollection)
        {
            ...
            _datatable.Columns.Add("SlNo", typeof(System.String));
            _datatable.Columns.Add("OrgName", typeof(System.String));
            _datatable.Columns.Add("OrgLocation", typeof(System.String));
            _datatable.Columns.Add("BookingDate", typeof(System.String));
            _datatable.Columns.Add("PatientNumber", typeof(System.String));
            ...
            _datatable.Columns.Add("EmailID", typeof(System.String));
            _datatable.Columns.Add("DispatchMode", typeof(System.String));
            _datatable.Columns.Add("RefDocName", typeof(System.String));
            _datatable.Columns.Add("Remarks", typeof(System.String));
            _datatable.Columns.Add("Salutation", typeof(System.String));
            _datatable.Columns.Add("CreatedBy", typeof(System.String));
            _datatable.Columns.Add("CreatedbyId", typeof(System.String));
            _datatable.Columns.Add("ClientID", typeof(System.String));
            _datatable.Columns.Add("LocationID", typeof(System.String));           
            _datatable.Columns.Add("ErrorStatus", typeof(System.String));
            ...
            _datatable.Columns.Add("OrgLocationID", typeof(System.String));
            ...
            foreach (HCBookingData _list in _lstCollection)
            {
                ...
                _datarow["OrgName"] = _list.OrgName;
                _datarow["OrgLocation"] = _list.OrgLocation;
                _datarow["BookingDate"] = _list.BookingDate;
                _datarow["PatientNumber"] = _list.PatientNumber;
                ...
                _datarow["EmailID"] = _list.EmailID;
                _datarow["DispatchMode"] = _list.DispatchMode;
                _datarow["RefDocName"] = _list.RefDocName;
                _datarow["Remarks"] = _list.Remarks;
                 _datarow["Salutation"] = _list.Salutation;
                _datarow["CreatedBy"] = _list.CreatedBy;
