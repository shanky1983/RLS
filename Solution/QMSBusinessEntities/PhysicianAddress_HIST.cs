...
{
	public class PhysicianAddress_HIST
	{
		#region Fields

		private long physicianAddress_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the PhysicianAddress_HISTID value.
		/// </summary>
		public long PhysicianAddress_HISTID
		{
			get { return physicianAddress_HISTID; }
			set { physicianAddress_HISTID = value; }
		}
