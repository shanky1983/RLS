...
{
	public class StockReceivedDetails_HIST
	{
		#region Fields

		private long stockReceivedDetails_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the StockReceivedDetails_HISTID value.
		/// </summary>
		public long StockReceivedDetails_HISTID
		{
			get { return stockReceivedDetails_HISTID; }
			set { stockReceivedDetails_HISTID = value; }
		}
