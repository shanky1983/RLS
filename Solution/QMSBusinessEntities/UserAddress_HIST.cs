...
{
	public class UserAddress_HIST
	{
		#region Fields

		private long userAddress_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the UserAddress_HISTID value.
		/// </summary>
		public long UserAddress_HISTID
		{
			get { return userAddress_HISTID; }
			set { userAddress_HISTID = value; }
		}
