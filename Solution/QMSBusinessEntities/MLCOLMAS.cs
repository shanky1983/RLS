...
namespace Attune.Solution.QMSBusinessEntities
{
	public class MLCOLMAS
	{
		...
		private string cLBILLADDR1=String.Empty;
		private string cLBILLADDR2=String.Empty;
		private string cLBILLADDR3=String.Empty;
		...
		private string cLTURNOVERDISC=String.Empty;
		...
		private string cLREPORTFORMAT=String.Empty;
		private string cLSPONSORYN=String.Empty;
		private string cLSPONSORCODE=String.Empty;
		private string cLTELE1=String.Empty;
		private string cLPRICELISTTYPECD=String.Empty;
		private string cLOLDCLCODE=String.Empty;
		private string cLMISGROUP=String.Empty;
		private string cLSTATIONARYTYPECD=String.Empty;
		private string cLRECEMAILYN=String.Empty;
		private string oLDSAPCODE=String.Empty;
		private string nEWSAPCODE=String.Empty;
		private string cLACCOUNTGRPCD=String.Empty;
		private int cLTRANSTIME=0;
		private string cLTATPARATYPE=String.Empty;
		private string cLMRPBASE=String.Empty;
		private string cLRECEIPTFORMAT=String.Empty;
		...
		/// <summary>
		/// Gets or sets the CLBILLADDR1 value.
		/// </summary>
		public string CLBILLADDR1
		{
			get { return cLBILLADDR1; }
			set { cLBILLADDR1 = value; }
		}

		/// <summary>
		/// Gets or sets the CLBILLADDR2 value.
		/// </summary>
		public string CLBILLADDR2
		{
			get { return cLBILLADDR2; }
			set { cLBILLADDR2 = value; }
		}

		/// <summary>
		/// Gets or sets the CLBILLADDR3 value.
		/// </summary>
		public string CLBILLADDR3
		{
			get { return cLBILLADDR3; }
			set { cLBILLADDR3 = value; }
		}
		...
		/// <summary>
		/// Gets or sets the CLTURNOVERDISC value.
		/// </summary>
		public string CLTURNOVERDISC
		{
			get { return cLTURNOVERDISC; }
			set { cLTURNOVERDISC = value; }
		}
		...
		/// <summary>
		/// Gets or sets the CLREPORTFORMAT value.
		/// </summary>
		public string CLREPORTFORMAT
		{
			get { return cLREPORTFORMAT; }
			set { cLREPORTFORMAT = value; }
		}

		/// <summary>
		/// Gets or sets the CLSPONSORYN value.
		/// </summary>
		public string CLSPONSORYN
		{
			get { return cLSPONSORYN; }
			set { cLSPONSORYN = value; }
		}

		/// <summary>
		/// Gets or sets the CLSPONSORCODE value.
		/// </summary>
		public string CLSPONSORCODE
		{
			get { return cLSPONSORCODE; }
			set { cLSPONSORCODE = value; }
		}

		/// <summary>
		/// Gets or sets the CLTELE1 value.
		/// </summary>
		public string CLTELE1
		{
			get { return cLTELE1; }
			set { cLTELE1 = value; }
		}
		...
		/// <summary>
		/// Gets or sets the CLPRICELISTTYPECD value.
		/// </summary>
		public string CLPRICELISTTYPECD
		{
			get { return cLPRICELISTTYPECD; }
			set { cLPRICELISTTYPECD = value; }
		}

		/// <summary>
		/// Gets or sets the CLOLDCLCODE value.
		/// </summary>
		public string CLOLDCLCODE
		{
			get { return cLOLDCLCODE; }
			set { cLOLDCLCODE = value; }
		}

		/// <summary>
		/// Gets or sets the CLMISGROUP value.
		/// </summary>
		public string CLMISGROUP
		{
			get { return cLMISGROUP; }
			set { cLMISGROUP = value; }
		}
		...
		/// <summary>
		/// Gets or sets the CLRECEMAILYN value.
		/// </summary>
		public string CLRECEMAILYN
		{
			get { return cLRECEMAILYN; }
			set { cLRECEMAILYN = value; }
		}
		...
		/// <summary>
		/// Gets or sets the CLACCOUNTGRPCD value.
		/// </summary>
		public string CLACCOUNTGRPCD
		{
			get { return cLACCOUNTGRPCD; }
			set { cLACCOUNTGRPCD = value; }
		}

		/// <summary>
		/// Gets or sets the CLTRANSTIME value.
		/// </summary>
		public int CLTRANSTIME
		{
			get { return cLTRANSTIME; }
			set { cLTRANSTIME = value; }
		}

		/// <summary>
		/// Gets or sets the CLTATPARATYPE value.
		/// </summary>
		public string CLTATPARATYPE
		{
			get { return cLTATPARATYPE; }
			set { cLTATPARATYPE = value; }
		}

		/// <summary>
		/// Gets or sets the CLMRPBASE value.
		/// </summary>
		public string CLMRPBASE
		{
			get { return cLMRPBASE; }
			set { cLMRPBASE = value; }
		}

		/// <summary>
		/// Gets or sets the CLRECEIPTFORMAT value.
		/// </summary>
		public string CLRECEIPTFORMAT
		{
			get { return cLRECEIPTFORMAT; }
			set { cLRECEIPTFORMAT = value; }
		}
