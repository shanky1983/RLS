...
{
	public class PatientDueChart_HIST
	{
		#region Fields

		private long detailsID_HIST=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the DetailsID_HIST value.
		/// </summary>
		public long DetailsID_HIST
		{
			get { return detailsID_HIST; }
			set { detailsID_HIST = value; }
		}
