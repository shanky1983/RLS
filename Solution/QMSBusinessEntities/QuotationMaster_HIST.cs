...
{
	public class QuotationMaster_HIST
	{
		#region Fields

		private long quotation_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the Quotation_HISTID value.
		/// </summary>
		public long Quotation_HISTID
		{
			get { return quotation_HISTID; }
			set { quotation_HISTID = value; }
		}
