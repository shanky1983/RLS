...
{
	public class LoginRole_HIST
	{
		#region Fields

		private long loginRole_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the LoginRole_HISTID value.
		/// </summary>
		public long LoginRole_HISTID
		{
			get { return loginRole_HISTID; }
			set { loginRole_HISTID = value; }
		}
