...
{
	public class HC_PatientInvestigation
	{
		#region Fields
		...
		private long transferredAccessionNo=0;
		private int processingLocation=0;
		private int pISSampleID=0;
		...
		/// <summary>
		/// Gets or sets the TransferredAccessionNo value.
		/// </summary>
		public long TransferredAccessionNo
		{
			get { return transferredAccessionNo; }
			set { transferredAccessionNo = value; }
		}

		/// <summary>
		/// Gets or sets the ProcessingLocation value.
		/// </summary>
		public int ProcessingLocation
		{
		...
		/// <summary>
		/// Gets or sets the PISSampleID value.
		/// </summary>
		public int PISSampleID
		{
			get { return pISSampleID; }
			set { pISSampleID = value; }
		}
