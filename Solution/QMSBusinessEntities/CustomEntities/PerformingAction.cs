...
{
    // public static long SendMail(string fromAddress, string toAddress, string ccAddress, 
    //string bccAddress, string subject, string body, string fromDisplay, List<MailAttachment> lstAttachment)
