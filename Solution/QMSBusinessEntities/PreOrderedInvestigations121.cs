...
{
	public class PreOrderedInvestigations121
	{
		#region Fields
		...
		private string oBR_Placer_Order_Number=String.Empty;
		...
		/// <summary>
		/// Gets or sets the OBR_Placer_Order_Number value.
		/// </summary>
		public string OBR_Placer_Order_Number
		{
			get { return oBR_Placer_Order_Number; }
			set { oBR_Placer_Order_Number = value; }
		}
