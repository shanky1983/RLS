...
{
	public class ProductSupplierRateMapping_HIST
	{
		#region Fields

		private long productMapping_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the ProductMapping_HISTID value.
		/// </summary>
		public long ProductMapping_HISTID
		{
			get { return productMapping_HISTID; }
			set { productMapping_HISTID = value; }
		}
