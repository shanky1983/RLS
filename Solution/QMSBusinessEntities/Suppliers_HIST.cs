...
{
	public class Suppliers_HIST
	{
		#region Fields

		private long supplier_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the Supplier_HISTID value.
		/// </summary>
		public long Supplier_HISTID
		{
			get { return supplier_HISTID; }
			set { supplier_HISTID = value; }
		}
