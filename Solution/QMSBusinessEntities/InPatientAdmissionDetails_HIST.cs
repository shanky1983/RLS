...
{
	public class InPatientAdmissionDetails_HIST
	{
		#region Fields

		private long inPatientRegID_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the InPatientRegID_HISTID value.
		/// </summary>
		public long InPatientRegID_HISTID
		{
			get { return inPatientRegID_HISTID; }
			set { inPatientRegID_HISTID = value; }
		}
