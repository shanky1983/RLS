...
{
	public class PatientAddress_HIST
	{
		#region Fields

		private long patientAddress_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the PatientAddress_HISTID value.
		/// </summary>
		public long PatientAddress_HISTID
		{
			get { return patientAddress_HISTID; }
			set { patientAddress_HISTID = value; }
		}
