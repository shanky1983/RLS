...
{
	public class MatchingStockReceived
	{
		#region Fields
		...
		private string matchingInvoice=String.Empty;
		...
		/// <summary>
		/// Gets or sets the MatchingInvoice value.
		/// </summary>
		public string MatchingInvoice
		{
			get { return matchingInvoice; }
			set { matchingInvoice = value; }
		}
