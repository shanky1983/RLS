...
{
	public class SupplierCreditorDebitReference
	{
		#region Fields

		private long supplierID=0;
		private long usedStockReceivedID=0;
		...
		/// <summary>
		/// Gets or sets the UsedStockReceivedID value.
		/// </summary>
		public long UsedStockReceivedID
		{
			get { return usedStockReceivedID; }
			set { usedStockReceivedID = value; }
		}
