...
namespace Attune.Solution.QMSBusinessEntities
{
	public class HC_PatientVisit
	{
		...
		private bool excludeRefPhyNotify=false;
		private bool isNeedDemographicBlind=false;
		private long assignedDoctorID=0;
		private long transferredOrgId=0;
		...
		/// <summary>
		/// Gets or sets the ExcludeRefPhyNotify value.
		/// </summary>
		public bool ExcludeRefPhyNotify
		{
			get { return excludeRefPhyNotify; }
			set { excludeRefPhyNotify = value; }
		}

		/// <summary>
		/// Gets or sets the IsNeedDemographicBlind value.
		/// </summary>
		public bool IsNeedDemographicBlind
		{
			get { return isNeedDemographicBlind; }
			set { isNeedDemographicBlind = value; }
		}

		/// <summary>
		/// Gets or sets the AssignedDoctorID value.
		/// </summary>
		public long AssignedDoctorID
		{
			get { return assignedDoctorID; }
			set { assignedDoctorID = value; }
		}

		/// <summary>
		/// Gets or sets the TransferredOrgId value.
		/// </summary>
		public long TransferredOrgId
		{
			get { return transferredOrgId; }
			set { transferredOrgId = value; }
		}
