                        ...
                        //                                          },
                                          ...
                                          { "mDataProp": "ExternalRefNo",
                                           ...
                                           { "mDataProp": "PassportNo",
                                               "fnRender": function(oObj) {
                                               return '	<label id="jPassportNumber" >' + oObj.aData.PassportNo + '</label>';
    ...
    function ValidateData() {
        ...
        try {
            $("#example tr:not(:first)").each(function(i, n) {
                ...
                if ($row.find("#jRegistrationDate").text() == "") {
                    var RegistrationDate = $('#hdnSystemDatetime').val();
                }
                else {
...
//                    SampleCollectionDate = "01-01-1900";
                ...
                var PassportNo = $row.find("#jPassportNumber").text();
                dtBulkReg.push({
                    OrgName: OrgName,
                    SlNo: SlNo,
...
<body>
    ...
    <asp:HiddenField ID="hdnSystemDatetime" runat="server" />
    </form>
