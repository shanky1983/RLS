                ...
                if (list[1] > 0) {
                    ...
                    if (result != "[]") {
                        ...
                        //                                          },
                                          ...
                                          { "mDataProp": "PassportNo",
                                              "fnRender": function(oObj) {
                                                  return '	<label id="jPassportNo" >' + oObj.aData.PassportNo + '</label>';
                                              }
                                          }
                                          ,
                                          { "mDataProp": "SampleNumber",
                                              "fnRender": function(oObj) {
                                              return '	<label id="jSampleID" >' + oObj.aData.SampleNumber + '</label>';
                                              }
                                          }
                ...
                if (result != "[]") {
                    oTable = $('#example1').dataTable({
                        ...
                        //                                          },
                                          ...
                                          { "mDataProp": "PassportNo",
                                              "fnRender": function(oObj) {
                                              return '	<label id="jPassportNo1" >' + oObj.aData.PassportNo + '</label>';
                                              }
                                          },
                                          { "mDataProp": "SampleNumber",
                                              "fnRender": function(oObj) {
                                                  return '	<label id="jSampleID1" >' + oObj.aData.SampleNumber + '</label>';
                                              }
                                          }
...
//                    SampleCollectionDate = "01-01-1900";
                ...
                var PassportNo = $row.find("#jPassportNo").text();
                var SampleID = $row.find("#jSampleID").text();
        ...
        try {
            $("#example1 tr:not(:first)").each(function(i, n) {
                ...
                if (checked) {
                    ...
                    var PassportNo = $row.find("#jPassportNo1").text();
                    var SampleID = $row.find("#jSampleID1").text();
