        ...
        <div id="divCoupon" runat="server" style="display: none;" class="divTab">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>
                        ...
                        <table class="dataheader2 defaultfontcolor w-100p" id="tblCouponDetail1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox CssClass="w-70" ID="txtExpiryDate" runat="server" meta:resourcekey="txtExpiryDateResource1"></asp:TextBox>
                                                        ...
                                                        <cc1:MaskedEditExtender ID="MaskedEditExtender5" runat="server" TargetControlID="txtExpiryDate"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" Text="Increase/Decrease" runat="server"></asp:Label>
                                </td>
                                <td>
                                   <asp:DropDownList ID="ddIncreaseDecrease" CssClass="ddl" runat="server">
                                   <asp:ListItem Selected="True" Value="update" Text="Update"></asp:ListItem>
                                   <asp:ListItem Value="inc" Text="Increase"></asp:ListItem>
                                   <asp:ListItem Value="dec" Text="Decrease"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                               </tr>
                            <tr>
                    ...
                    <asp:HiddenField ID="hdnConsumedUnits" runat="server" />
                    <asp:HiddenField ID="hdnOrderedunitspresent" runat="server" />
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
...
//        });
	...
	var userMsg1= SListForAppMsg.Get("Admin_DiscountMaster_aspx_19") != null ? SListForAppMsg.Get("Admin_DiscountMaster_aspx_19") : "Enter Starting Serail No.";
        ...
        function ClearCouponMaster() {
            ...
            document.getElementById('hdnConsumedUnits').value = '';
            document.getElementById('hdnOrderedunitspresent').value = '';
            return false;
        }
...
<script language="javascript" type="text/javascript">
    ...
    function getcouponmasterrowid(rid, CouponID, Code, Name, Status) {
        ...
        document.getElementById('hdnCouponID').value = CouponID;
        //arun -if edit - button name should be update instead of save
        var updateDisplay = SListForAppMsg.Get("Admin_DiscountMaster_aspx_update") != null ? SListForAppMsg.Get("Admin_DiscountMaster_aspx_update") : "Update";
        document.getElementById('btnSaveCouponMaster').value = updateDisplay;
    }
    function ClearCouponDetails() {
        document.getElementById('ddlCoupon').value = '-1';
        document.getElementById('txtStartSerialNo').value = '';
    ...
    function getcoupondetailsrowid(rid, CouponDetailID, CouponID, StartSerialNo, EndSerialNo, BatchNo, OrderedUnits, CouponValue, ExpiryDate, ConsumedUnits) {
        ...
        document.getElementById('txtExpiryDate').value = ExpiryDate.substring(0, 10);
        document.getElementById('hdnCouponID').value = CouponDetailID;
        document.getElementById('hdnConsumedUnits').value = ConsumedUnits;
        document.getElementById('hdnOrderedunitspresent').value = OrderedUnits;
        Temp();
        //arun -if edit - button name should be update instead of save
        var updateDisplay = SListForAppMsg.Get("Admin_DiscountMaster_aspx_update") != null ? SListForAppMsg.Get("Admin_DiscountMaster_aspx_update") : "Update";
        document.getElementById('btnSaveCouponDetails').value = updateDisplay;
    }
    function SelectedClientValue(source, eventArgs) {
        var Name = eventArgs.get_text();
        var ID = eventArgs.get_value();
