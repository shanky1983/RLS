<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserMaster.aspx.cs" Inherits="Admin_UserMaster"
    Debug="true" meta:resourcekey="PageResource1" EnableEventValidation="false" %>
                                                        ...
                                                        <td>
                                                            <asp:GridView ID="grdResult" runat="server" AllowPaging="True" CellPadding="2" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="CreatedAt" HeaderText="Created Date"  DataFormatString="{0:dd/MM/yyyy hh:mm tt}" > 
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Status" HeaderText="Status"> 
                                                                    </asp:BoundField>                                                                     
                                                                      <asp:BoundField  DataField="PlaceOfBirth" HeaderText="InActive date"> 
                                                                    </asp:BoundField>  
                                                                    <asp:BoundField DataField="Remarks" HeaderText="User Location"> 
                                                                    </asp:BoundField>
                                                                    <%--<asp:BoundField DataField="ModifiedAt" HeaderText="Last login date"> 
                                                                    </asp:BoundField>--%>
                                                                    <asp:TemplateField HeaderText="Last login date" >
                                                                    <ItemTemplate>
                                                                    <asp:Label ID="lblName" Text='<%# Eval("ModifiedAt").ToString().Equals("01/01/1900 00:00:00") ? "" : Eval("ModifiedAt") %>'
                                                                    runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="FORENAME" HeaderText="User Dept Name"> 
                                                                    </asp:BoundField>
                                                                </Columns>
                                                            </asp:GridView>
                                                    ...
                                                    <td colspan="4">
                                                        <table class="w-100p">
                                                            <tr>
                                                                ...
                                                                <td colspan="1"  >
                                                                <asp:Label ID="lblFranchiseeClientName" runat="server" Text="Franchishee Client Name" Visible="false"  Enabled="false"> </asp:Label>
                                                                </td>
                                                                <td> 
                                                                <asp:TextBox  id="tblFranchiseeClientName" runat="server" Visible="false" Enabled="false" > </asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
