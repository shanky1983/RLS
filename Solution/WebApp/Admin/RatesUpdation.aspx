                            ...
                            <table class="dataheader2 searchPanel w-100p">
                                ...
                                <tr>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <%--arun changes--%>
                                        <asp:HiddenField ID="hdnHideLabShareAmnt" runat="server" />
                                    </td>
                                </tr>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="hdnLabShareamount" runat="server" Value='<%# Eval("LabAmount") %>' />
                                                            <asp:HiddenField ID="hdnFranchiseeamount" runat="server" Value='<%# Eval("FranchiseeAmount") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                        ...
                        <td>
                            ...
                            <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup dataheaderPopup" Style="width: 600px;
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>                                    
                                    <table class="w-100p" id="LabShareAmount">
                                         <tr class="dataheader1">
                                                <td nowrap="nowrap" style="width:220px;padding:5px 5px 5px 5px;">
                                                    <asp:Label ID="Label13" Text="Test Name" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap" style="width:109px;">
                                                    <asp:Label ID="Label14" Text="Type" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap" style="width:150px;">
                                                    <asp:Label ID="Label16" Text="Rate Card" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap" >
                                                    <asp:Label ID="Label17" Text="MRP/Base Rate Card" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                              <tr id="LabShareAmountData">
                                                <td nowrap="nowrap" style="padding-top:5px;padding-bottom:20px;">
                                                    <div ID="Testnamelbl" runat="server" style="word-break: break-all;white-space: normal;"></div>
                                                </td>
                                                <td nowrap="nowrap" style="padding-top:5px;padding-bottom:20px;">
                                                    <asp:Label ID="Typelbl" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap" style="padding-top:5px;padding-bottom:20px;">
                                                    <asp:Label ID="Ratecardlbl" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap" style="text-align:center;padding-top:5px;padding-bottom:20px;">
                                                    <asp:Label ID="Baseratelbl" runat="server"></asp:Label>                                                    
                                                </td>
                                            </tr>
                                              <tr class="dataheader1">
                                                <td nowrap="nowrap" style="padding:5px 5px 5px 5px;">
                                                    <asp:Label ID="Label24" Text="Client Price" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap">
                                                    <asp:Label ID="Label25" Text="Lab Share Amount" runat="server"></asp:Label>
                                                </td>
                                                <td nowrap="nowrap">
                                                    <asp:Label ID="Label26" Text="Franchisee Share Amount" runat="server"></asp:Label>
                                                </td>  
                                                <td nowrap="nowrap">                                                    
                                                </td>                                                
                                            </tr>
                                              <tr id="Tr1">
                                                <td nowrap="nowrap" style="padding-top:10px;padding-bottom:20px;">
                                                    <%--<asp:Label ID="ClientPricelbl" runat="server"></asp:Label>--%>
                                                       <asp:TextBox ID="ClientPriceTxt" runat="server" MaxLength="20" Style="text-align: right;"
                                                        CssClass="Txtboxverysmall"></asp:TextBox>
                                                </td>
                                                <td nowrap="nowrap" style="padding-top:10px;padding-bottom:20px;">
                                                    <asp:TextBox ID="LabShareAmountTxt" runat="server" MaxLength="20" Style="text-align: right;"
                                                        CssClass="Txtboxverysmall"></asp:TextBox>
                                                </td>
                                                <td nowrap="nowrap" style="padding-top:10px;padding-bottom:20px;">
                                                    <asp:TextBox ID="FranchiseeTxt" runat="server" MaxLength="20" Style="text-align: right;"
                                                        CssClass="Txtboxverysmall"></asp:TextBox>
                                                </td>                                                
                                            </tr>                                            
                                              <tr>
                                                <td class="a-center" colspan="4">
                                                    <asp:Button ID="Button2" runat="server" Text="Save" CssClass="btn" OnClientClick="javascript:return Close_ModalPOP_Hide1();" />
                                                    <asp:Button ID="Button3" type="button" Text="Close" runat="server" OnClientClick="javascript:return ClientClose();"
                                                        CssClass="btn" />
                                                </td>
                                            </tr>
                                    </table>
                                        <table class="w-100p" id="OldHeader">                                        
                                            <tr class="dataheader1">
                                                <td nowrap="nowrap">
            ...
            $("#divgv table tr").each(function() {
                ...
                if ($(tr).find("input:text[id$=txtAmount]").val() != undefined) {
                    ...
                    if (chk == true) {
                        ...
                        //debugger;
                        ///arun changes
                        var hdnLabShareamt = $(tr).find("input:hidden[id$=hdnLabShareamount]") ? $(tr).find("input:hidden[id$=hdnLabShareamount]").val() : '';
                        var hdnFranchiseeamt = $(tr).find("input:hidden[id$=hdnFranchiseeamount]") ? $(tr).find("input:hidden[id$=hdnFranchiseeamount]").val() : '';
                        ...
                        //arun changes
                       '~' + hdnLabShareamt + '~' + hdnFranchiseeamt +'^';
...
//            debugger;
            ...
            var RateValue = document.getElementById("hdnRateID").value.split('~');//arun changes
            ...
            //arun changes
        //    debugger;
            var ishdnHideLabShareAmnt = document.getElementById('hdnHideLabShareAmnt').value;
            tempid = id;
            if (ishdnHideLabShareAmnt == "Y") {
                document.getElementById("LabShareAmount").style.display = "block";
                document.getElementById("OldHeader").style.display = "none";

                var baserate = ids[0] + '_' + ids[1] + '_' + 'lblGeneralAmount';
                var testname = ids[0] + '_' + ids[1] + '_' + 'lblDescriptionName';
                var hdnlabshareamount1 = ids[0] + '_' + ids[1] + '_' + 'hdnLabShareamount';
                var hdnFranchiseeamount1 = ids[0] + '_' + ids[1] + '_' + 'hdnFranchiseeamount';

                var ratename = document.getElementById('hdnRateName').value;
                var Feetype = "";
                var feetypeselectedvalue = "";
                feetypeselectedvalue = document.getElementById('ddlFeeType').value;
                Feetype = feetypeselectedvalue == 'HEALTH_PACKAGE' ? "PACKAGE" :
                      feetypeselectedvalue == 'INVESTIGATION_FEE' ? "INVESTIGATION" :
                      feetypeselectedvalue == 'INVESTIGATION_GROUP_FEE' ? "GROUP" :
                      feetypeselectedvalue == 'MEDICAL_INDENTS_RATES' ? "MEDICAL INDENT" :
                      feetypeselectedvalue == 'PHYSICIAN_FEE' ? "PHYSICIAN FEE" :
                      feetypeselectedvalue == 'PROCEDURE_FEE' ? "PROCEDURE FEE" :
                      feetypeselectedvalue == 'SURGERY_PACKAGE' ? "SURGERY PACKAGE" :
                      feetypeselectedvalue == 'GENERAL_BILLING_ITEMS' ? "GENERAL BILLING ITEM" : "";

                document.getElementById("Testnamelbl").innerText = document.getElementById(testname).innerText;
                //arun
                //document.querySelector('Testnamelbl').classList.toggle('ow');}, false);
                document.getElementById("Typelbl").innerText = Feetype;
                document.getElementById("Ratecardlbl").innerText = document.getElementById("txtRateCard").value;

                if (ratename == "GENERAL") {
                    document.getElementById("Baseratelbl").innerText = $('#' + OPAmount + '').val();
                } else {
                    if (document.getElementById(baserate) != null && document.getElementById(baserate) != undefined) {
                            document.getElementById("Baseratelbl").innerText = document.getElementById(baserate).innerText;
                        }
                        else {
                            document.getElementById("Baseratelbl").innerText = $('#' + OPAmount + '').val();
                        }    //$('#' + OPAmount + '').val();
                }
                document.getElementById("ClientPriceTxt").value = $('#' + OPAmount + '').val();
              //  document.getElementById("ClientPricelbl").innerText = $('#' + OPAmount + '').val();
                document.getElementById("LabShareAmountTxt").value = $('#' + hdnlabshareamount1 + '').val() != "" && $('#' + hdnlabshareamount1 + '').val() != null && $('#' + hdnlabshareamount1 + '').val() != undefined ? $('#' + hdnlabshareamount1 + '').val() : "0.00";
                document.getElementById("FranchiseeTxt").value = $('#' + hdnFranchiseeamount1 + '').val() != "" && $('#' + hdnFranchiseeamount1 + '').val() != null && $('#' + hdnFranchiseeamount1 + '').val() != undefined ? $('#' + hdnFranchiseeamount1 + '').val() : "0.00";
                //
            }
            else {
                document.getElementById("LabShareAmount").style.display = "none";
                document.getElementById("OldHeader").style.display = "block";
            }
        ...
        //arun changes
        function Close_ModalPOP_Hide1() {
          //  debugger;
            var ids = tempid.split('_');
            var hdnlabshareamount1 = ids[0] + '_' + ids[1] + '_' + 'hdnLabShareamount';
            var hdnFranchiseeamount1 = ids[0] + '_' + ids[1] + '_' + 'hdnFranchiseeamount';
            var OPAmount = ids[0] + '_' + ids[1] + '_' + 'txtAmount';
            document.getElementById(OPAmount).value = document.getElementById("ClientPriceTxt").value;
            var labshre = document.getElementById('LabShareAmountTxt').value;
            var frnach = document.getElementById('FranchiseeTxt').value;
            $('#' + hdnlabshareamount1 + '').val(labshre != "" && labshre != null && labshre != undefined ? labshre:"0");
            $('#' + hdnFranchiseeamount1 + '').val(frnach != "" && frnach != null && frnach != undefined ? frnach : "0");

            document.getElementById('LabShareAmountTxt').value = "";
            document.getElementById('FranchiseeTxt').value = ""; 
