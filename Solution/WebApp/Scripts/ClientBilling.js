                                            ...
                                            //changes by arun prasad - b2b reg - delete service is not working when we choose the service already exists patient details
                                             ...
                                             //
                                                ...
                                                if (document.getElementById('billPart_hdnitemleveldiscountneed').value == "Y") {
                                                    ...
                                                    //+ "|";
                                                        + "~IsSpecialTest^" + IsSpecialTest1 + "~Ishtmltab^" + Ishtmltab1 + "~IsTemplateID^" + IsTemplateID1 + "~IsMandatoryHis^" + IsMandatoryHis + "~ClientRate^" + Clientrate + "~MRPAmount^" + MRP + "~DiscountValue^" + ItemDiscountValue + "~ItemDiscountPercentage^" + ItemDisPercent + "~DiscountReason^" + DiscountReason + "~ClientValue^" + ClientValue + "~MRPValue^" + MRPValue + "|";
                                                }
                                                else {
                                                    FeeViewStateValue = "FeeID^" + defalutdata[0] + "~FeeType^" + defalutdata[2] + "~Descrip^" + defalutdata[1] +
                                                        "~Amount^" + defalutdata[3] + "~Quantity^" + 1 + "~Remarks^" + defalutdata[5] + "~ReportDate^" + defalutdata[7] +
