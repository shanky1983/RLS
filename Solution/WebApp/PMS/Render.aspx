...
<head>
    ...
    <title>DataTable - File export</title>
...
<%--added--%>
<%--2added--%>
 <link href="css/buttons.dataTables.min.new.css" rel="stylesheet" type="text/css" />
 <link href="css/jquery.dataTables.min.new.css" rel="stylesheet" type="text/css" />
<%--2added--%>

    <%--<script src="js/jquery-1.11.3.min.js" language="javascript" type="text/javascript"></script>--%>
    <%--2added--%>
    <script src="js/jquery-1.12.3.new.js" language="javascript" type="text/javascript"></script>
    <%--2added--%>
<%--added--%>
 <%--<script src="js/jquery-3.5.1.js" language="javascript" type="text/javascript"></script>--%>
 <%--added--%>
  ...
  <%--2added--%>
    <script src="js/jquery.dataTables.min.new.js" language="javascript" type="text/javascript"></script>
  <%--2added--%>
...
<%--added--%>
<%--2added--%>
<script src="js/dataTables.buttons.min.new.js" language="javascript" type="text/javascript"></script>
<script src="js/jszip.min.new.js" language="javascript" type="text/javascript"></script>
<script src="js/pdfmake.min.new.js" language="javascript" type="text/javascript"></script>
<script src="js/vfs_fonts.new.js" language="javascript" type="text/javascript"></script>
<script src="js/buttons.html5.min.new.js" language="javascript" type="text/javascript"></script>
<%--2added--%>
    <style type="text/css">       
        .DynamicTableov
        {
...
//        });
        ...
        function FilterLocation(obj) {
            var id = obj.id;
            var orgid = document.getElementById(obj.id).value;
            var orgname = $("#" + obj.id + " option:selected").text();
            var input, filter, ul, li, a, i;
//            input = document.getElementById("pToLocationID");
//            filter = input.value.toUpperCase();
            div = document.getElementById("pToLocationID");
            if (div != null && id != "pToLocationID") {
                a = div.getElementsByTagName("option");
                for (i = 0; i < a.length; i++) {
                    txtValue = a[i].textContent || a[i].innerText;
                    ddlid = a[i].value;
                    if (orgid != "-1") {
                        if (txtValue.toUpperCase().indexOf(orgname.toUpperCase()) > -1) {
                            a[i].style.display = "";
                        }
                        else if (ddlid==-1) {
                            a[i].style.display = "";
                        ...
                        if (list[0].length > 0) {
                            ...
                            $.each(ListParam, function(i, obj) {
                                ...
                                if (CtrlType.toLowerCase() == 'datetime') {
                                    ...
                                    var ddl = $('<select id="' + obj.ParamName + '" onChange="FilterLocation(this)">');
        ...
        function RunReport() {
            ...
            $.each(lstParams, function(i, obj) {
                ...
                if (ctlType == "INPUT") {
                    ...
                    if (ddlIndex == 0 && isOptional == "false" && obj.ParamName!="pToLocationID") {
                        returnValue = false;
                    }
