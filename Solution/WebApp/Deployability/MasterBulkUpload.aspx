    ...
    <script language="javascript" type="text/javascript">
        ...
        $('#btndownloadtemplatedata0').click(function() {
            ...
            if (result) {
                ...
                //arun changes
                var hdnLabshareamt = $('#hdnHideLabShareAmnt').val();
                $('#iframeExcel').attr('src', 'MasteruploadExportToExcelHandler.ashx?FileType=' + filetype + '&Type=' + type + '&OrgID=' + OrgID + '&LID=' + LID + '&RateId=' + RateId + '&ratetext=' + ratetext + '&OrgName=' + OrgName + '&HideLabShareAmnt=' + hdnLabshareamt);
                $('#iframeExcel').load();
            }
            $('#preloader').hide(5000);
        });
...
//                debugger;
                var vHideLabShareAmnt = $('#hdnHideLabShareAmnt').val();
                if (vHideLabShareAmnt == "Y") {
                    filename = "RateMaster_Franchisee" + fileextension;
                }
                else {
...
if (selectedtype == "PhysicianMaster") {
        ...
        function AddFiletoFolderRM() {
            ...
            if (result) {
                ...
                var hdnLabshareamt = $('#hdnHideLabShareAmnt').val();
                $.ajax({
                url: 'MasterfileuploadHandler.ashx?FileType=' + filetype + '&Type=' + type + '&OrgID=' + OrgID + '&LID=' + LID + '&HideLabShareAmnt=' + hdnLabshareamt,
                    type: "POST",
                    contentType: false,
                    processData: false,
                    data: FileDetails,
