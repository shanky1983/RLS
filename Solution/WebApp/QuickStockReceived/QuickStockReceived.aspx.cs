    ...
    protected void btnFinish_Click(object sender, EventArgs e)
    {
        ...
        try
        {
           ...
           // objStockReceived.Tax = Convert.ToDecimal(txtTotaltax.Text);
            ...
            objStockReceived.TCSPercentage = hdnTcsTaxPer.Value == "" ? Convert.ToDecimal(0.00) : decimal.Parse(hdnTcsTaxPer.Value);
            objStockReceived.TCSValue = txtTCS.Text == "" || txtTCS.Text == null ? Convert.ToDecimal(0.00) : decimal.Parse(txtTCS.Text);	
