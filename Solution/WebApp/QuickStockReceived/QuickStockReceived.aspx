                                                            ...
                                                            <tr>
                                                                <td>
                                                                     <table class="w-100p" runat="server" >
                                                                        <tr class="hide" id="tblTCS">
                                                                            <td class="w-50p">
                                                                                <asp:Label ID="lblTCStax" runat="server" Text="TCS Tax "
                                                                                    meta:resourcekey="lalTCStaxResource1"></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtlblTCS" onkeypress="return ValidateSpecialAndNumeric(this);" CssClass="smaller a-right"
                                                                                    runat="server" Text="0.00"  meta:resourcekey="txtlblTCSResource1"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                ...
                                                                <td>
                                                                   <table class="w-100p">
                                                                        <tr id="trDeliveryCharges" runat="server">
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtDeliveryCharges" CssClass="smaller a-right" onkeypress="return ValidateMultiLangChar(this);"  onblur="checkAddToTotal();" Enabled="true" runat="server" Text="0.00"
