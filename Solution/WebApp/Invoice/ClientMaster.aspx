        ...
        function checkisempty() {
            ...
            */
            ...
            if (document.getElementById('chkisparent').checked == false) {
			    ...
			    //changes by arun - Invoice Checkbox - Invoie cylce -if one selected and need to select another one 
            if (document.getElementById('hdnAlrtInvoiceCycleMandatory').value == 'Y') {
                var index = -1;
                var chkbox1 = document.getElementById("chkClientAttributes");
                var inputArr1 = chkbox1.getElementsByTagName('input');
                var labelArr1 = chkbox1.getElementsByTagName('label');
                for (var d = 0; d < chkbox1.getElementsByTagName('label').length; d++) {
                    if (chkbox1.getElementsByTagName('label')[parseInt(d)].innerHTML == "Invoice") {
                        index = parseInt(d);
                    }
                }
                if (document.getElementById('chkClientAttributes_' + index).checked == true && document.getElementById("ddlInvoiceCycle").value == "") {
                    ValidationWindow(UsrAlrtMsg211, AlrtWinHdr);
                    return false;
                }
                if (document.getElementById('chkClientAttributes_' + index).checked == false && document.getElementById("ddlInvoiceCycle").value != "") {
                    ValidationWindow(UsrAlrtMsg212, AlrtWinHdr);
                    return false;
                }
            }
            //
                                                ...
                                                <asp:Panel ID="pnlas" runat="server" meta:resourcekey="pnlasResource1">
                                                    <table class="w-100p">
                                                     ...
                                                     <%--                                           <asp:RadioButtonList ID="RdoClientRmtAccess" runat="server" RepeatDirection="Horizontal"
                                                                                            ...
                                                                                            <td id="tdFranchisee" style="display: none;" runat="server">
                                                                                            <span class="richcombobox" style="width: 155px;" nowrap="nowrap">
                                                                                            <asp:DropDownList ID="ddlFranchisee" runat="server" CssClass="ddl" Width="153px">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="width: 220px;">
                                                                                                                        <asp:TextBox ID="txtaddres1" runat="server" MaxLength="100" TextMode="MultiLine"
                                                                                                                            CssClass="Txtboxsmall" AutoComplete="off"   OnKeyPress="return ValidateMultiLangCharacter(this) || ValidateRestrictedSpecialAndNumeric(this);" 
                                                                                                                    ...
                                                                                                                    <td width="170px">
                                                                                                                        <asp:TextBox ID="txtSubUrban" runat="server" Width="170px" CssClass="Txtboxsmall"
                                                                                                                            AutoComplete="off" meta:resourcekey="txtSubUrbanResource1" onkeypress="return checksign(this);"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td style="width: 120px;">
                                        ...
                                        <asp:Panel ID="Panel8" runat="server" Height="165px" GroupingText="LogoUpload" meta:resourcekey="Panel8resource">
                                           ...
                                           <%--Franchisee Changes by Surya--%>
                                            <table id="Table34" runat="server" width="100%">
                                                <tr>
                                                    <td id="tdClientLogoStatus" runat="server" style="display: none;">
                                                ...
                                                <tr id="trflUpload" style="display: none;" runat="server">
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnLogoView" Text="View" runat="server" Visible="false" CssClass="btn" Width="100px"
                                                            ...
                                                            <td id="Td18" runat="server">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                    <ContentTemplate>
																		...
																		<%--//changes by arun - Invoice Checkbox - Invoie cylce -if one selected and need to select another one --%>
                                                    <input type="hidden" id="hdnAlrtInvoiceCycleMandatory" runat="server" value="N" />
                                                                        <%--VEL--%>
...
//            $('#RdoClientRmtAccess').on('click', function(e) {
            if (e.target.id == 'RdoClientRmtAccess_0') {
                if (this.checked) {
                    ...
                    document.getElementById('tdFranchisee').style.display = 'none';
                }
                ...
                if ($("#RdoClientRmtAccess_1").is(':checked') || $("#RdoClientRmtAccess_2").is(':checked')) {
                    ...
                    if ($("#RdoClientRmtAccess_2").is(':checked')) {
                        //                        $('#ddlFranchisee').show();
                        document.getElementById('tdFranchisee').style.display = 'block';
                    }
                    else {
                    ...
                    $("#RdoClientRmtAccess_0").prop("checked", true);
                    document.getElementById('tdFranchisee').style.display = 'none';
                }
             }
