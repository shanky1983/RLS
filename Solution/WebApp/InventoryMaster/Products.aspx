...
<body>
    <form id="prFrm" runat="server">
        ...
        <script language="javascript" type="text/javascript">
           ...
           function CheckReorderConsumptionlevel(id) {
           
                var PackSize =$("#txtPackSize").val();
                var RCLVal = $(id).val();
                
                if (RCLVal =="") {
                    alert("Please Enter Reorder Consumption level");
                    $(id).val("0").focus();
                    return false;
                }                
                if(Number(RCLVal) >Number(PackSize)){                
                 alert("Please Enter Reorder Consumption level less than Test/Pack Count");        
                 $(id).val("0").focus();         
                }
            }
                                    ...
                                    <tr class= "panelContent" >
                                        ...
                                        <td id="tdConReOrderLeveltxt" class="hide">
                                          <asp:TextBox OnKeyPress="return ValidateMultiLangChar(this)" ID="txtConReOrderLevel" MaxLength="3"
                                                runat="server" Text="0" onblur="CheckReorderConsumptionlevel(this);" onKeyDown="return  isNumeric(event,this.id)"
