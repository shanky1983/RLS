...
<%--    <link href="StyleSheets/Common.css" rel="stylesheet" type="text/css" />--%>
 ...
 <script type="text/javascript" src="Scripts/aes.js"></script> 
    ...
    function checkNullOrUndefined(data)
    {
	 ...
	 //arun - captcha changes
        function hiderror() {
        var lblCaptchaMessage = document.getElementById("lblCaptchaMessage");
        if(checkNullOrUndefined(lblCaptchaMessage))
            lblCaptchaMessage.style.display = "none";
        }
    //
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div class="w-100p displaytb">
                    <div class="w-50p o-auto displaytd">
                        ...
                        <tr id="CaptchaRow3" runat="server">
                        <td id="Td113" colspan="2" width="153" runat="server">
                             <asp:Image ID="Image2" runat="server" Height="55px" Width="186px" />  
                <br />  
                <asp:Label runat="server" ID="lblCaptchaMessage" ForeColor="red"></asp:Label> 
                               <asp:LinkButton ID="RefreshGo" CssClass="marginR10" Text="Refresh" style="color:Green;font-size:12px;"
                                        OnClick="RefreshGo_Click" runat="server"  />
                        </td>
                        </tr>
                        <tr id="CaptchaRow1" runat="server">
                            <td id="Td111" colspan="2" width="153" runat="server">
                                    <asp:TextBox ID="TextBox111" runat="server" CssClass="Txtboxstyle bdr-radius-2" style="width:145px;display:none;" size="6" maxlength="6"
                                     disabled meta:resourcekey="txtUserNameResource111"></asp:TextBox>
                               
                               <asp:Label ID="LablCaptcha1" Text=""  runat="server" Width="140" Font-Strikeout="True" Font-Size="XX-Large" />
                               
                                <asp:LinkButton ID="refreshcaptcha" ForeColor="Green" Font-Size="12px"  Text="Refresh" OnClick="refreshcaptcha_Click"   Font-Underline ="true" 
                                 runat="server"></asp:LinkButton>
                                                 <asp:Label runat="server" ID="lblCaptchaMessage2" ForeColor="red"></asp:Label> 
                                </td>
                                </tr> 
                        <tr  id="CaptchaRow2" runat="server">
                            <td id="Td112" colspan="2" width="153" runat="server">
                                    <asp:TextBox ID="TextBox112" runat="server" CssClass="Txtboxstyle bdr-radius-2" autocomplete="off" size="6" maxlength="6" AutoCompleteType="Disabled" onclick ="hiderror()" 
                                    meta:resourcekey="txtCaptchResource1"></asp:TextBox>
                                </td>
                                 </tr> 
                        <tr>
