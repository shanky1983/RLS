...
public partial class Investigation_checkInvest : BaseControl
{
    ...
    //arun - deptwisebulkapproval
    /// <summary>
    /// Gets or sets the PatientID value.
    /// </summary>
	private bool _isShowPastReport = false;
    public bool IsShowPastReport
    {
        get { return _isShowPastReport; }
        set { _isShowPastReport = value; }
    }
    private long _bulkPatientID = 0;
    public long BulkPatientID
    {
        get { return _bulkPatientID; }
        set { _bulkPatientID = value; }
    }
    //
