...
public partial class Investigation_InvestigationResultsCapture : BasePage, System.Web.UI.ICallbackEventHandler
{
    ...
    public Control loadBioControl(PatientInvestigation lstInve)
    {
        ...
        try
        {
            ...
            {
                CLogger.LogError("Error on loadBioControl IsAbnormal", e);
            }
...
if (ddlstatus.Items.FindByValue("Completed_2") != null)
    ...
    public void drawNewPatternMethod()
    {
        ...
        sJsFuntion.Append(" CallAllReferenceRangeValidate(); } catch (e) { return true; }");
    ...
    private long AutoSave()
    {
        ...
        try
        {
            ...
            foreach (var O in lstPatientInv)
            {
                ...
                ////////}
                //////////////karthick//////////////////
                else if ((O.Status == "Completed" || O.Status == "Pending") && (O.IsAbnormal == "N" || O.IsAbnormal == "") && O.AutoApproveLoginID > 0 && hdnIsExcludeAutoApproval.Value == "N" && O.IsAutoAuthorize == "Y" && O.IsAutoCertification == "Y")
                {
                    ...
                    else if (O.IsAutoValidation != "Not Apporved" && O.Status != "Pending")
                    {
