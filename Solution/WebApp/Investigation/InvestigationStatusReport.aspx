...
<link href="../Scripts/InvestigationStatusReport/buttons.dataTables.min.new.css" rel="stylesheet" type="text/css" />
    <link href="../Scripts/InvestigationStatusReport/jquery.dataTables.min.new.css" rel="stylesheet" type="text/css" />
    ...
    <div class="contentdata">
        <div id="Export_XL" runat="server" style="margin-top: 40px;text-align:left;">
            ...
            <asp:ImageButton ID="ImageButton2" runat="server"  ImageUrl="~/Images/ExcelImage.GIF"
                Style="z-index: 1; left: 1275px; top: 104px; position: absolute" OnClick="btnConverttoXL_Click" />
        </div>
                                            ...
                                            <asp:GridView ID="gvDuplicate2" runat="server" AutoGenerateColumns="False" HeaderStyle-Height="25px"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="TATLeft" HeaderText="DelayLogger" SortExpression="TATLeft"
														...
														<asp:BoundField DataField="ModifiedUser" HeaderText="UpdateUser" SortExpression="ModifiedUser" />
                                                </Columns>
                                                <FooterStyle CssClass="dataheader1" HorizontalAlign="Right" />
                                                <PagerStyle CssClass="dataheader1" HorizontalAlign="Center" />
                                                <HeaderStyle CssClass="dataheader1" />
...
<script src="../Scripts/InvestigationStatusReport/bootstrap.min.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/datetimepicker_css.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/jquery.dataTables.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/dataTables.tableTools.min.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/TableTools.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/TableTools.min.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/dataTables.bootstrap.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/dataTables.buttons.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/jszip.min.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/pdfmake.min.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/vfs_fonts.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/buttons.html5.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/InvestigationStatusReport/ZeroClipboard.js" language="javascript" type="text/javascript"></script>
           ...
           oLanguage: {
                ...
                "buttons": [
                                    ...
                                    },
                                    {
                                        ...
                                        filename: 'Test_Pdf',
                                        exportOptions: { modifier: { page: 'all'} },
                                        customize: function(tst) {
                                            // debugger;
                                            tst.defaultStyle.fontSize = 10;
                                            tst.pageOrientation = "landscape";
                                            tst.styles.tableFooter.fontSize = 10;
                                            tst.styles.tableHeader.fontSize = 10;
                                        }
                                    }
                          ]
//                "sDom": '<"H"Tfr>t<"F"ip>',
