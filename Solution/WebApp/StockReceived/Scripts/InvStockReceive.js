...
function Tblist() {
    ...
    if (hdnNeedVat == "Y") {    
        strTax = "<th class='tbltax' colspan='2' > VAT(%)</th>";
        GSTTax ="<tr class='responstableHeader'><th >%</th><th >Amt</th> </tr>";        
    }
    else {    
        strTax = "<th class='tbltax' colspan='6'>GST(%)</th>";
        
        GSTTax= "<tr class='responstableHeader'>"
    ...
    $.each(lstProductList, function(obj, value) {
        ...
        if (hdnNeedVat == "Y") {
            hideTaxCol = "<td class='a-right'>" + (parseFloat(value.Tax)).toFixed(2) + "</td>" + "<td class='a-right'>" 
                         + (parseFloat((((value.UnitPrice - (value.UnitPrice * value.Discount / 100)) * value.Tax / 100)) * value.RECQuantity)).toFixed(2) + "</td>";
        }
        else {
            hideTaxCol =  "<td class='a-right'>" + cgstper + "</td>"
...
//                        + "<td class='a-right'>" + igstamt + "</td>"
                        ...
                        //+"<td class='a-right hide'>" + pPurchaseTax + "</td>
                        
                        + "<td class='a-right'>"+ pSellingPrice + "</td><td class='a-right'>"
    ...
    if(hdnNeedVat=="Y") //RM03
    {   
        $("#lblTTAmount").text("Total VAT Amount");
        $("#trCGST").addClass('hide');
        $("#trSGST").addClass('hide');
        $("#trIGST").addClass('hide');
    }
