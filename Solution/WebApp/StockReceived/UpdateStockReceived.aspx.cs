...
public partial class StockReceived_UpdateStockReceived : Attune_BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string HideGST = GetConfigValue("NeedInventoryVatReqYN", OrgID);
            if (HideGST == "Y")
            {
                grdResult.Columns[19].Visible = false;
                grdResult.Columns[20].Visible = false;
                grdResult.Columns[21].Visible = false;
                grdResult.Columns[22].Visible = false;
                grdResult.Columns[23].Visible = false;
                grdResult.Columns[24].Visible = false;
