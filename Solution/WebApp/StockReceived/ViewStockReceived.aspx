    ...
    <div class="contentdata">
        <div id="divReceived" runat="server">
            ...
            <table class="w-100p">
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView CssClass="w-100p"  EmptyDataText="No matching records found " ID="grdResult" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="VAT / Tax (%)" DataField="Tax" ItemStyle-HorizontalAlign="Right"
                                    DataFormatString="{0:N}" ></asp:BoundField> <%--meta:resourcekey="BoundFieldResource15"--%>
                    ...
                    <td class="a-right w-20p" style="width:20% !important; text-align:right !important;">
                        <table id="tblAmountDetails" runat="server" class="w-100p a-right" cellspacing="5">
                            ...
                            <tr id="totalTaxAmt" runat="server">
                                <td class="a-left">
                                    <%--<%=Resources.ClientSideDisplayTexts.Inventory_ViewStockReceived_TotalTaxAmount%>--%>
