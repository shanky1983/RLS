...
public partial class CommonControls_MethodKitMapping : BaseControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        fckInterpretation.BasePath = sPath;
        fckInterpretation.ToolbarSet = "Attune";
        fckInterpretation.ToolbarStartExpanded = false;
        fckInterpretation.ImageBrowserURL = sPath + "editor/filemanager/browser/default/browser.html?Type=Image&Connector=connectors/aspx/connector.aspx";
        fckInterpretation.LinkBrowserURL = sPath + "editor/filemanager/browser/default/browser.html?Connector=connectors/aspx/connector.aspx";

        fckQCData.BasePath = sPath;
        fckQCData.ToolbarSet = "Attune";
        fckQCData.ToolbarStartExpanded = false;
        fckQCData.ImageBrowserURL = sPath + "editor/filemanager/browser/default/browser.html?Type=Image&Connector=connectors/aspx/connector.aspx";
        fckQCData.LinkBrowserURL = sPath + "editor/filemanager/browser/default/browser.html?Connector=connectors/aspx/connector.aspx";
