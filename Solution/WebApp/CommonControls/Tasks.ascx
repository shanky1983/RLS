...
<asp:UpdatePanel ID="ctlTaskUpdPnl" runat="server">
    <ContentTemplate>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function checkForVisitIdValues() {                
                var visitnumber = document.getElementById('<%= txttext.ClientID %>').value;
                if (visitnumber != null && visitnumber != undefined && visitnumber != "" && visitnumber != "Visit Number") {
                }
                else {
                                ...
                                <td class="h-23 a-right">
                                    <asp:Panel ID="Panel1" runat="server" DefaultButton="btn_Go" meta:resourcekey="Panel1Resource4">
                                        ...
                                        <asp:Button runat="server" ID="btn_Go" Text="Go" CssClass="btn1 h-20" onmouseover="this.className='btn1 btnhov1'"
                                            onmouseout="this.className='btn1'" OnClientClick="javascript:return checkForVisitIdValues();" OnClick="btn_Go_Click" meta:resourcekey="btn_GoResource1" />
        ...
        <asp:HiddenField ID="hdnRoleDescription" Value="" runat="server" />
...
<script type="text/javascript">
    ...
    function SelectMaster() {
        //debugger;//When Cancel test task search with the visit number/Name,it leads to the empty page
        var hdnRoleDesc = document.getElementById('<%= hdnRoleDescription.ClientID %>').value;
      //  alert(hdnRoleDesc);
        if (hdnRoleDesc == "Sr Credit Controller" || hdnRoleDesc == "Credit Controller") {
