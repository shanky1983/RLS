    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {         
               ...
               string IsdisplayRobotofontonly = GetConfigValues("IsdisplayRobotofontonly", OrgID);
                if (!string.IsNullOrEmpty(IsdisplayRobotofontonly))
                {
                    string[] fontFaces = { "Roboto" };
                    string[] fontFaceNames = { "Roboto" };
                    FCKeditor1.FontFacesMenuList = fontFaces;
                    FCKeditor1.FontFacesMenuNames = fontFaceNames;
                    FCKeditor2.FontFacesMenuList = fontFaces;
                    FCKeditor2.FontFacesMenuNames = fontFaceNames;
                    FCKeditor3.FontFacesMenuList = fontFaces;
                    FCKeditor3.FontFacesMenuNames = fontFaceNames;
                }
