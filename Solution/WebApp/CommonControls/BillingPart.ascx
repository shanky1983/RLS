                    ...
                    <tr id="trSTATOutSource" runat="server" style="display: table-row;">
                        <td colspan="2">
                            ...
                            <asp:TextBox ID="txtpkgcolor" Style="background-color: #6699FF;" ReadOnly="True"
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblclientrate" runat="server" Text="Client Rate" Visible="false"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblMRP" runat="server" Text="MRP" Visible="false"></asp:Label>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblitemdiscounttype" runat="server" Text="Select Discount" Visible="false"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             
                            <asp:Label ID="lblitemdiscountvalue" runat="server" Text="Value" Visible="false"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblitemdiscountreason" runat="server" Text="Discount Reason" Visible="false"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              &nbsp;&nbsp;&nbsp;&nbsp;
                           
                            <asp:Label ID="lblitemAmount" runat="server" Text="Amount" Visible="false"></asp:Label>
                        </td>
                                ...
                                <tr>
                                    <td class="w-100p">
                                        ...
                                        <asp:TextBox ID="txtVariableRate" runat="server" Style="display: none;" 
                                            ...
                                            <asp:TextBox ID="txtclientrate" runat="server" CssClass="Txtboxverysmall" Visible="false" Text="0.00" onkeypress="return ValidateOnlyNumeric(this);" onBlur="checkDiscountValue(this.id);" Enabled="false"></asp:TextBox>&nbsp;
                                            <asp:HiddenField ID="hdnClientRateFRA" runat="server" Value="0.00" />
                                            <asp:TextBox ID="txtMRP" runat="server" CssClass="Txtboxverysmall" Visible="false" Text="0.00" onkeypress="return ValidateOnlyNumeric(this);" onBlur="checkDiscountValue(this.id);" Enabled="false"></asp:TextBox>&nbsp;
                                            <asp:HiddenField ID="hdnMRPRateFRA" runat="server" Value="0.00" />
                                            <asp:DropDownList ID="ddlitemdiscountType" runat="server" CssClass="ddlsmall" Visible="false" onChange="javascript:SetItemDiscountAmt();"></asp:DropDownList>&nbsp;
                                            <asp:TextBox ID="txtdiscountvalue" runat="server" CssClass="Txtboxverysmall" Visible="false" Text="0.00" onkeypress="return ValidateOnlyNumeric(this);" onBlur="checkDiscountValue(this.id);" Enabled="false"></asp:TextBox> &nbsp;
                                            <asp:DropDownList ID="ddlitemdiscountReson" runat="server" CssClass="ddlsmall" Visible="false" ></asp:DropDownList>&nbsp;
                                            <asp:TextBox ID="textdiscountAmount" runat="server" CssClass="Txtboxverysmall" Visible="false"  Text="0.00" onkeypress="return ValidateOnlyNumeric(this);" onBlur="checkDiscountValue(this.id);" Enabled="false"></asp:TextBox>&nbsp;
            ...
            <div id="divBill3" title="Billing Details">
                ...
                <div runat="server" id="divtemplate" style="display:none;">
                   ...
                   <%-- VEL--%>
				    ...
				    <asp:HiddenField ID="hdnitemleveldiscountneed" runat="server" Value="N" />
