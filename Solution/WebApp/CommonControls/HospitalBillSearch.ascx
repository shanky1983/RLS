...
<script type="text/javascript" language="javascript">
    ...
    function SelectBillNo(rid, patid, billno, Refundstatus, vType, isCreditBill, visitstate, CollectionType, ReceivedAmount, RefundAmount, TotAmount, IsCoPaymentBill, IsTransfered,IsFranchisee) {
        //debugger;
        ...
        document.getElementById('<%=hdnisfranchisee.ClientID %>').value = IsFranchisee;
...
<asp:Panel ID="pnlPSearch" runat="server" GroupingText="Search for Bills Issued"
    ...
    <asp:HiddenField ID="hdnisfranchisee" runat="server" value="0" />
    </table>
