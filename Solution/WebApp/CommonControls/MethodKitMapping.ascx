...
<script language="javascript" type="text/javascript">
    ...
    function onClickAdd() {
        ...
        var oEditor1 = FCKeditorAPI.GetInstance('ucMethodKitCapture_fckInterpretation');
        if (oEditor1.GetHTML(true).trim() != "") {
            interpretation = oEditor1.GetHTML(true);
        }
        var oEditor2 = FCKeditorAPI.GetInstance('ucMethodKitCapture_fckQCData');
        if (oEditor2.GetHTML(true).trim() != "") {
            qcData = oEditor2.GetHTML(true);
        }
        ...
        if (document.getElementById('ucMethodKitCapture_hdnMethodKit').value != "") {
            ...
            //document.getElementById('ucMethodKitCapture_fckInterpretation').value = "";
            FCKeditorAPI.GetInstance('ucMethodKitCapture_fckInterpretation').SetHTML('');
            document.getElementById('ucMethodKitCapture_ddlPrinciple').value = "0";
            //            document.getElementById('ucMethodKitCapture_fckQCData').value = "";
            FCKeditorAPI.GetInstance('ucMethodKitCapture_fckQCData').SetHTML('');
            return false;
        }
        if (AddStatus == 0) {
            var row = document.getElementById('ucMethodKitCapture_tabMethodKit').insertRow(0);
        ...
        if (document.getElementById('ucMethodKitCapture_hdnMethodKit').value != "") {
            document.getElementById('ucMethodKitCapture_tabMethodKitHeader').style.display = "table";
        }
        else {
    ...
    function setQCData(value) {
        if (document.getElementById('ucMethodKitCapture_hdnQCData').value != "") {
            ...
            for (var count = 0; count < x.length - 1; count++) {
                var y = x[count].split("~");
                if (y[0] == value) {
                    //document.getElementById('ucMethodKitCapture_fckQCData').value = y[1];
                    FCKeditorAPI.GetInstance('ucMethodKitCapture_fckQCData').SetHTML(y[1]);
                }
            }
        }
    }
            ...
            <div class="dataheader2">
                <table>
                    ...
                    <tr class="font10 bold h-15 a-left" style="color: #000000;">
                        ...
                        <td colspan="3" class="a-left">
                            <FCKeditorV2:FCKeditor ID="fckQCData" runat="server" Width="360px" Height="70px">
                    ...
                    <tr class="h-15 font10 bold a-left" style="color: #000000;">
                        ...
                        <td colspan="3" class="a-left">
                            <FCKeditorV2:FCKeditor ID="fckInterpretation" runat="server" Width="360px" Height="70px">
                            </FCKeditorV2:FCKeditor>
                        </td>
                    </tr>
                    <tr class="h-15 font10 bold a-left" style="color: #000000;">
