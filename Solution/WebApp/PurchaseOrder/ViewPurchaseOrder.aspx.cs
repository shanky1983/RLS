...
public partial class PurchaseOrder_ViewPurchaseOrder : Attune_BasePage
{
        ...
        : base("PurchaseOrder_ViewPurchaseOrder_aspx")
   {
        ...
        try
        {
            ...
            if (lstOrganization.Count > 0 && lstInventoryItemsBasket.Count > 0)
            {
                ...
                if (lstPurchaseOrders[0].Comments != "")
                {
                    ...
                    displayTool = displayTool == null ? "Note:" : displayTool;
                    commentsTD.InnerHtml = "<hr/>" + displayTool + lstPurchaseOrders[0].Comments;
                    //end
                }
    ...
    public void LoadPurchaseOrderItems(List<ProductCategories> lstPO, List<InventoryItemsBasket> lstIIB)
    {
        ...
        //Hari's code starts
        string isVATReq = GetConfigValue("NeedInventoryVatReqYN", OrgID);
        ...
        {
            cellH8.Text = "Vat / Tax (%)";
            cellH8.Width = Unit.Percentage(15);
            cellH8.Style.Add("border", "1px solid #ddd");
            cellH8.Attributes.Add("colspan", "2");
            cellH8.Attributes.Add("class", "a-center");
        ...
        if (isVATReq.Trim() == "Y")
        {
            ...
            cellH13.Attributes.Add("class", "a-center v-middle");
            
            cellH14.Text = "Amt";
            cellH14.Style.Add("border", "1px solid #ddd");
            cellH14.Attributes.Add("rowspan", "2");
            cellH14.Attributes.Add("class", "a-center v-middle");
