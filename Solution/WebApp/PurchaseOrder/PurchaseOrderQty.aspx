<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseOrderQty.aspx.cs" Inherits="PurchaseOrder_PurchaseOrderQty" meta:resourcekey="PageResource1" EnableEventValidation="false"
    %>
...
<body>
    <form id="form1" runat="server" defaultbutton="btnGeneratePO">
        ...
        <input id="hdnNeedVAT" runat="server" type="hidden" value="N" />
