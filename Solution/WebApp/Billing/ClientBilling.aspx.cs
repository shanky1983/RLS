...
public partial class Billing_ClientBilling : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string NeedPassportNoinVisitLevel = GetConfigValue("NeedPassportAsVisitLevel", OrgID);

            hdnissrfid.Value = UseWarNoAsSRFID == "Y" ? UseWarNoAsSRFID : "N";
            hdnPassport.Value = NeedPassportNoinVisitLevel == "Y" ? NeedPassportNoinVisitLevel : "N";
    ...
    public void SaveData()
    {
        ...
        try
        {
            ...
            if (hdnPassport.Value == "Y")
            {
                ContextInfo.AdditionalInfo = "" + "|" + "" + "~" + txtpassportno.Text;
            }
