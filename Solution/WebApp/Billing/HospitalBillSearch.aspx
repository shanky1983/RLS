    ...
    <script language="javascript" type="text/javascript">
      ...
      function HideModalPopupcheckmrik() {
        ...
        function CheckVisitID() {
            ...
            var vIsFranchiseealert = SListForAppMsg.Get('Billing_HospitalBillSearch_aspx_19') == null ?"Refund can not be done for this bill. This is Franchisee patient":SListForAppMsg.Get('Billing_HospitalBillSearch_aspx_19') ;
            ...
            var IsFranchisee = document.getElementById('uctrlBillSearch_hdnisfranchisee').value;
            var Franchisee='<%=IsFranchisee %>';
            if (IsFranchisee == "1" && Franchisee!="Y") {
                ValidationWindow(vIsFranchiseealert, AlertType);
                return false;
            }
