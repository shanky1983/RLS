...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FranchiseeBilling.aspx.cs"
                                            ...
                                            <tr id="trPatientPriorityPart" runat="server">
                                                ...
                                                <td id="tdRefDrParttxt" runat="server">
                                                    ...
                                                    <img src="../Images/starbutton.png" alt="" class="a-center" runat="server" ID="NeedRefPhyNeed" visible="false"/>
                                                     <div id="divcapturePhysician" class="hide">
                                                        <table> <tr>
                                                        <td><asp:Label ID="lblnewPhy" runat="server" Text="Physician Name"></asp:Label></td>
                                                        <td><asp:TextBox ID="txtnewPhy" runat="server" autocomplete="off" onkeypress="return ValidateSplChar(event.keyCode);"></asp:TextBox></td>
                                                         <td><input id="btnAddphy" onclick="onSaveRefPhysician();" type="button" value="Add" /></td>
                                                        </tr></table>
                                                    </div>
                           
                             <img id="btnaddPhysician"  src="../Images/plus.png" onclick="javascript:return RefsListPopupBilling();" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                               <td id="tdHubID" runat="server" nowrap="nowrap">
                                                    <asp:Label ID="lblHubID" runat="server" Text="Health HubID" meta:resourcekey="lblHubIDResource1"></asp:Label>
                                                </td>
...
<%--                                <input runat="server" value=<%=Resources.Billing_ClientDisplay.Billing_BillingPart_aspx_10 %> type="button" id="btnClose" style="width:100px;" class="btn" onclick="clearbuttonClick()" />--%>
    ...
    <asp:HiddenField ID="hdnPageType" runat="server" Value="B2F" />
    ...
    <asp:HiddenField ID="hdnpreviousdue" Value="0.00" runat="server" />
	 ...
	 <input id="hdnMRPBillDisplay" type="hidden" value="N" runat="server" /> 
	  <input id="hdnAvailDepositAmt" runat="server" value="0" type="hidden" />
        ...
        <input id="hdnAdvanceClienthavedeposit" runat="server" value="0" type="hidden" />
...
<asp:HiddenField ID="hdnAllowGreaterAmtfromMrp" Value="N" runat="server" /> 
 <input id="hdnClientAmountFranchisee" type="hidden" value="0" runat="server" />
 <asp:HiddenField ID="hdnPassport" runat ="server" Value="" />
...
//                },
    ...
    <script src="../Scripts/CommonBilling_Franchisee.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>
 ...
 <script type="text/javascript">
     ...
     function Validategender() {
        ...
        function ValidateRefPhysician() {
            ...
            var vRefAlert = "Please select the physician from the completion list OR Add in Physician List";
            if (_AllowFreeText == 'N') {
