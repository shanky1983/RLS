...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckingBillFeeDetails.aspx.cs"
                                        ...
                                        <table class="w-100p">
                                            ...
                                            <tr>
                                               <td id="tdHubID" runat="server" nowrap="nowrap">
                                                    <asp:Label ID="lblHubID" Text="Health HubID" runat="server" meta:resourcekey="lblHubIDResource1"></asp:Label>
                                                </td>
                                            ...
                                            <tr id="tdAdditionalDetails" runat="server" style="height:36.5px">
                                                <td colspan="2" nowrap="nowrap">
                                                    <asp:CheckBox ID="chkExcludeAutoathz" Text="Exclude Auto Authorization" runat="server"  meta:resourcekey="chkExcludeAutoathzResource1" />
                                                </td>
                                                <td>
                                                </td>
                                                <td>
            ...
            <tr>
                <td class="dataheader3 a-center">
                    <table class="w-100p">
                        <tr>
                            <td>
                                <asp:Button ID="btnGenerate" runat="server" Visible="false" Width="100px" Text="Generate Bill" CssClass="btn"
...
<%--                                <input runat="server" value=<%=Resources.Billing_ClientDisplay.Billing_BillingPart_aspx_10 %> type="button" id="btnClose" style="width:100px;" class="btn" onclick="clearbuttonClick()" />--%>
    ...
    <asp:HiddenField ID="hdnPageType" runat="server" Value="B2Bill" />
