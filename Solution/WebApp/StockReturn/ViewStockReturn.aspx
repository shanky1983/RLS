...
<script type="text/jscript">
  function HideforGSTandGSTReq()
      {
       if($("#hdnNeedInventoryVatTaxReq").val()=="Y")
       {
         $(".HideforVATReq").hide();
       }
       else{
...
<body>
                                ...
                                <asp:DataList ID="grdStockReturn" Width="100%" runat="server">
                                        ...
                                        <table width="100%" cellspacing="0" rules="all" border="1" style="margin-top: 10px;
                                            ...
                                            <tr>
                                               ...
                                               <th rowspan="3">
                                                ...
                                                <th colspan="6" class="HideforVATReq">
                                                    GST
                                                </th>
                                                <th colspan="2">
                                                    VAT
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="2" class="HideforVatReq">
                                                    CGST
                                                </th>
                                                <th colspan="2" class="HideforVatReq">
                                                    SGST
                                                ...
                                                <th rowspan="2" class="HideforGSTReq">
                                                    %
                                                </th>
                                                <th rowspan="2" class="HideforGSTReq">
                                                    Amt
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="HideforGSTReq">
                                                <%# string.Format("{0:n}", Eval("TaxPercent"))%>
                                            </td>
                                              <td class="HideforGSTReq">
                                                <%# string.Format("{0:n}", Eval("TaxAmount"))%>
                                            </td>
                                            <td>
    ...
    <asp:HiddenField ID="hdnNeedInventoryVatTaxReq" runat="server" Value="N" />
