                                                ...
                                                <asp:Panel ID="pnlSearch" CssClass="w-100p" runat="server" meta:resourcekey="pnlSearchResource1">
                                                    <table cellpadding="2" class="dataheaderInvCtrl w-100p" cellspacing="2">
                                                        ...
                                                        <tr id="trSampleBarcode">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtSampleBarcode" runat="server"  CssClass="small" meta:resourcekey="txtSampleBarcodeResource1" onkeypress="searchKeyPress(event);if (event.keyCode == 13){return false;}"></asp:TextBox>
                                                                &nbsp;<img src="../Images/starbutton.png" alt="" align="middle" />
