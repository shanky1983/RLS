...
<body oncontextmenu="return false;">
                                ...
                                <asp:GridView ID="grdResult" runat="server" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                      ...
                                      <%--  <asp:BoundField DataField="ExternalVisitID" HeaderText="Lab No" meta:resourcekey="lobNoResource" Visible ="false"  />--%>
                                        ...
                                        <asp:BoundField DataField="IsFranchisee" HeaderText="Franchisee" Visible="false"/>
    ...
    <input type="hidden" id="hdnISFrachisee" runat="server" value="N" />
    <input type="hidden" id="hdnISGridFRA" runat="server" value="N" />
 ...
 <script type="text/javascript">
     //changes by arun - reprint trfbarcode--
     var trf = document.getElementById("ddlVisitActionName"); // select element
     var strTRF = trf.options[trf.selectedIndex].value;

     if (strTRF == 'Reprint_TRFBarcode_SampleSearch') {
         document.getElementById("txtprintCnt").style.display = "block";
     }
     else {
     ...
     function Select_Visit(id, vid, pid, PName, vtype, vstid, vs, PNo, IsFra) {
         ...
         document.getElementById("hdnISGridFRA").value = IsFra;
     ...
     function CheckVisitID() {
         ...
         var Frachisee = document.getElementById("ddlVisitActionName"); // select element
         var FranchiseeSelect = Frachisee.options[Frachisee.selectedIndex].value;

         AlertType = SListForAppMsg.Get('Reception_AddressBook_aspx_02') == null ? "Alert" : SListForAppMsg.Get('Reception_AddressBook_aspx_02');
         if (FranchiseeSelect == 'Edit_LabPatient_Registration_Details') {
             if ((document.getElementById("hdnISGridFRA").value).toLowerCase() == "true" && document.getElementById("hdnISFrachisee").value != "Y") {
                 ValidationWindow("Cannot Edit the Franchisee Patient!", AlertType);
                 return false;
             }
         }
