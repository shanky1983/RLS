...
public partial class Reception_VisitDetails : BasePage
{
    ...
    string RestrictViewRegistrationForclientRole = string.Empty;
   ...
   string strUnknownF = Resources.CommonControls_ClientDisplay.CommonControls_TestMaster_ascx_086 == null ? "UnKnown" : Resources.CommonControls_ClientDisplay.CommonControls_TestMaster_ascx_086;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hdnISFrachisee.Value = IsFranchisee;
        ...
        if (!Page.IsPostBack)
        {
            ...
            RestrictViewRegistrationForclientRole = GetConfigValue("RestrictViewRegistrationForclientRole", OrgID);
    ...
    protected void grdResult_RowDataBound(Object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (RestrictViewRegistrationForclientRole == null)
                {
                    RestrictViewRegistrationForclientRole = "N";
                  
                }
                LinkButton lnk = (LinkButton)e.Row.FindControl("lnkvisitno");
                if (RoleName == "Client" && RestrictViewRegistrationForclientRole == "Y")
                {
                ...
                string strScript = "Select_Visit('" + ((RadioButton)e.Row.Cells[1].FindControl("rdSel")).ClientID + "','"
                    ...
                    + pv.WardNo + "','" + pv.PatientNumber + "','" + pv.IsFranchisee + "');";
                ...
                if (IsFranchisee != "Y" && pv.IsFranchisee == true)
                {
                    LinkButton lnkviewbill = (LinkButton)e.Row.FindControl("LnkViewBill");

                    lnkviewbill.Enabled = false;
