                                                ...
                                                <td class="w-25p v-top">
                                                    <fieldset>
                                                        ...
                                                        <table cellspacing="5" class="w-100p bg-row">
                                                            ...
                                                            <tr>
                                                                <td id="tdpassportnumber" runat="server" style="display:none">
                                                                    <asp:Label ID="RS_PassportNo" runat="server" Text="Passport Number :" ></asp:Label>
                                                                </td>
                                                                <td id="tdPassportNumber1" runat="server" style="display:none">
...
--%>
    <%--  <script type="text/javascript" src="../Scripts_New/jquery-1.9.1.min.js"></script>--%>
      <script src="../Scripts/jquery.MultiFile.js" language="javascript" type="text/javascript"></script>
    <script src="../Scripts/AdobeReaderDetection.js" language="javascript" type="text/javascript" />
    <script src="../Scripts/jquery-1.2.2.pack.js" language="javascript" type="text/javascript"></script>
    <script src="../Scripts/LabQuickBilling.js" language="javascript" type="text/javascript"></script>
    
    
    <%--<script src="../Scripts/audithistory/jquery-1.12.3.new.js" language="javascript" type="text/javascript" ></script>--%>
    <script src="../Scripts/audithistory/bootstrap.min.js" language="javascript" type="text/javascript" ></script>
    <script src="../Scripts/audithistory/jquery.dataTables.min.new.js" language="javascript" type="text/javascript" ></script>
    <script src="../Scripts/audithistory/dataTables.tableTools.min.js" language="javascript" type="text/javascript" ></script>
    ...
    <script src="../Scripts/audithistory/dataTables.bootstrap.js" language="javascript" type="text/javascript" ></script>    
    <script src="../Scripts/jquery.dataTables.rowGrouping.js" language="javascript" type="text/javascript"></script>
    <%--<script src="../Scripts/audithistory/jquery-ui.min.js" language="javascript" type="text/javascript" ></script>    --%>
    <script src="../Scripts/audithistory/dataTables.buttons.min.new.js" language="javascript" type="text/javascript" ></script>    
    <script src="../Scripts/audithistory/jszip.min.new.js" language="javascript" type="text/javascript" ></script>     
    <script src="../Scripts/audithistory/pdfmake.min.new.js" language="javascript" type="text/javascript" ></script>    
    <script src="../Scripts/audithistory/vfs_fonts.new.js" language="javascript" type="text/javascript" ></script>  
    <script src="../Scripts/audithistory/buttons.html5.min.new.js" language="javascript" type="text/javascript" ></script>    
        ...
        function AjaxGetFieldDataSucceeded(result) {
            ...
            ,
                "mRender": function(data, type, full) {
                    return '<label ID="dtme">' + GetCorrectdate1(data) + '</label>';
                }
            },
            { "mDataProp": "User" },
            { "mDataProp": "Location" },
            ...
            { "mDataProp": "ActionType"}],
                ...
                //
                $('#example').show();
                //$('#example').dataTable().disable();                
                if (parseInt(vIsAvailGrpng) == 0) {
                    ...
                    vIsAvailGrpng = parseInt(vIsAvailGrpng) + 1;
                }
                pop.hide();

                //       
                setTimeout(function () {                         
                    var el = document.getElementById('example_filter');                     
