...
<body oncontextmenu="return false;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSpecialCharacters(e) {
            if (document.getElementById('hdnRestrictSplCharinReferDoct').value == 'Y') {
                var keyCode = e.keyCode == 0 ? e.charCode : e.keyCode;
                var ret = (keyCode == 40 || keyCode == 41 || keyCode == 32 || keyCode == 8 || keyCode == 42 || keyCode == 57 || keyCode == 48 || (keyCode >= 97 && keyCode <= 122)
     && e.charCode == e.keyCode);
                if (
            (keyCode == 40 || keyCode == 41 || keyCode == 32 || keyCode == 8 || keyCode == 42 || (keyCode >= 97 && keyCode <= 122) || (keyCode >= 65 && keyCode <= 90))
            ) {
                    e.returnValue = true;
                }
                else {
...
//                }
                                    ...
                                    <tr class="a-left">
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtDrName" TabIndex="2" ToolTip="Refering Physician(Doctor) Name"
                                              onkeypress="validateSpecialCharacters(event)"  onchange="GetOrgName()" runat="server" CssClass="small" MaxLength="60" 
	...
	<input type="hidden" id="hdnRestrictSplCharinReferDoct" runat="server" value="N" />
