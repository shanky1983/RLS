                    ...
                    <tr class="a-center">
                        <td class="a-left">
                            <div class="dataheaderWider">
                                <table id="tbl">
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtClientName" runat="server" TabIndex="8" CssClass="AutoCompletesearchBox" onfocus="javascript:ClearClientDetails();" 
                                                         meta:resourcekey="txtClientNameResource1"></asp:TextBox>
                                                    <ajc:AutoCompleteExtender ID="AutoCompleteExtenderClientTask" runat="server" CompletionInterval="1"
                                ...
                                <td>
                                    <asp:TextBox ID="txtTestName" CssClass="small" runat="server" 
        ...
        function GetResult() {
            ...
            try {
                if (Valiadte()) {
                    ...
                    var ClientName =$('#hdnSelectedClientName').val();
                    var ClientID =$('#hdnSelectedClientID').val();
                    var TestName =$('#hdnTestName').val();
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: "{ pFromdt: '" + FromDate + "',pTodt: '" + ToDate + "',pOrgID: '" + OrgID + "',pOrgAddressID: '" + Location + "',pClientName: '" + ClientName +"',pClientID: '" + ClientID +"',pTestName: '" + TestName +"',pTestID: '" + TestID + "'}",
...
//                    }
    ...
    <script type="text/javascript">
        ...
        function ClearClientDetails() {
            document.getElementById('<%= hdnSelectedClientID.ClientID %>').value = "-1";
            document.getElementsByName('<%= hdnSelectedClientName.ClientID %>').item = "-1";
