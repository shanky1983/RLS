...
<head id="Head1" runat="server">
    ...
    <%--added--%>
<%--    <link href="../PMS/css/buttons.dataTables.min.css" rel="stylesheet" type="text/css" />
<link href="../PMS/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />--%>
<%--added--%>
<%--2added--%>
  ...
  background-color:#d6e9c6
    ...
    <script type="text/javascript">
        ...
        function SelectedClient(source, eventArgs) {
            ...
            var ID = list[0];
           //if list[0] contains client id and code, it should be separate
            ID = list[0].indexOf('|') > -1 ? list[0].split("|")[0] : list[0];
                        ...
                        <td class="a-left">
                            <div class="dataheaderWider">
                                <table id="tbl">
                                    ...
                                    <%-- <tr>
                                        <td colspan="6">
                                            <div id="divDynamic" runat="server" style="width:1350px; height:500px; overflow:auto;">
...
<%--2added--%>
<script src="../js/CustomizationReport/jquery-1.12.3.new.js" language="javascript" type="text/javascript"></script>
<%--2added--%>
...
<script src="../js/jquery.dataTables.min.js" language="javascript" type="text/javascript"></script>
  <%--2added--%>
<%--    <script src="../js/CustomizationReport/jquery.dataTables.min.new.js" language="javascript" type="text/javascript"></script>--%>
  <%--2added--%>
...
<%--added--%> 
<%--<script src="../js/dataTables.buttons.min.js" language="javascript" type="text/javascript"></script>
<script src="../js/buttons.flash.min.js" language="javascript" type="text/javascript"></script>
<script src="../js/jszip.min.js" language="javascript" type="text/javascript"></script>
<script src="../js/pdfmake.min.js" language="javascript" type="text/javascript"></script>
<script src="../js/vfs_fonts.js" language="javascript" type="text/javascript"></script>
<script src="../js/buttons.html5.min.js" language="javascript" type="text/javascript"></script>
 <script src="../js/buttons.print.min.js" language="javascript" type="text/javascript"></script>--%>
 <%--<script src="js/jquery.dataTables.min.js" language="javascript" type="text/javascript"></script>--%>

<%--added--%>
<%--2added--%>
<script src="../js/CustomizationReport/dataTables.buttons.min.new.js" language="javascript" type="text/javascript"></script>
<script src="../js/CustomizationReport/jszip.min.new.js" language="javascript" type="text/javascript"></script>
<script src="../js/CustomizationReport/pdfmake.min.new.js" language="javascript" type="text/javascript"></script>
<script src="../js/CustomizationReport/vfs_fonts.new.js" language="javascript" type="text/javascript"></script>
<script src="../js/CustomizationReport/buttons.html5.min.new.js" language="javascript" type="text/javascript"></script>
<%--2added--%>
    ...
    <script type="text/javascript">
        ...
        function AjaxGetFieldDataSucceeded(result) {
            ...
            try {
                ...
                //               
                    var el = document.getElementById('DynamicTable_filter');                     
                    if(el !=undefined && el != null && el != ""){
                        el.addEventListener('keydown', function(event) { 
                            ...
                            var value =$(".input-sm").val().slice(0,parseInt(event.target.selectionStart)-1)+$(".input-sm").val().slice(parseInt(event.target.selectionStart));
                            $(".input-sm").val(value);                            
                            }
                            else if (key === "Delete") { 
                            var cursorposition = event.target.selectionStart;
                            if(parseInt(event.target.selectionStart) >0)
                            var value = $(".input-sm").val().slice(0,parseInt(event.target.selectionStart))+$(".input-sm").val().slice(parseInt(event.target.selectionStart)+1,$(".input-sm").val().length);
                            $(".input-sm").val(value)                            
                            } 
                        }); 
                    }
