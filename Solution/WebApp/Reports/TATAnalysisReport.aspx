                    ...
                    "buttons": [
                                    ...
                                    },
                                    {
                                        ...
                                        customize: function(tst) {
                                            // debugger;
                                            tst.defaultStyle.fontSize = 6;
                                            tst.pageOrientation = "landscape";
                                            tst.styles.tableFooter.fontSize = 6;
                                            tst.styles.tableHeader.fontSize = 6;
                                        }
                                    }
                          ]
                    //"sDom": 'T<"clear">lfrtip',
...
<body>
    ...
    <script src="../Scripts/Tatanalysisreport/bootstrap.min.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/datetimepicker_css.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/jquery.dataTables.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/dataTables.tableTools.min.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/TableTools.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/TableTools.min.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/dataTables.bootstrap.js" language="javascript"
        type="text/javascript"></script>

    <%-- <script src="../Scripts/tatreport/jquery-ui.min.js" language="javascript" type="text/javascript" ></script>--%>

    <script src="../Scripts/Tatanalysisreport/dataTables.buttons.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/jszip.min.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/pdfmake.min.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/vfs_fonts.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/Tatanalysisreport/buttons.html5.min.new.js" language="javascript"
        type="text/javascript"></script>

    <%--<script src="../Scripts/tatreport/datetimepicker_css.js" language="javascript" type="text/javascript" ></script>--%>

    <script src="../Scripts/Tatanalysisreport/ZeroClipboard.js" language="javascript" type="text/javascript"></script>
