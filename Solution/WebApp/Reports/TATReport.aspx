...
<%--<script src="../Scripts/tatreport/jquery-1.12.3.new.js" language="javascript" type="text/javascript"></script>--%>
<script src="../Scripts/tatreport/bootstrap.min.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/datetimepicker_css.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/jquery.dataTables.min.new.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/dataTables.tableTools.min.js" language="javascript" type="text/javascript" ></script>
    
   <script src="../Scripts/tatreport/TableTools.js" language="javascript" type="text/javascript" ></script>
    <script src="../Scripts/tatreport/TableTools.min.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/dataTables.bootstrap.js" language="javascript" type="text/javascript" ></script>
<%-- <script src="../Scripts/tatreport/jquery-ui.min.js" language="javascript" type="text/javascript" ></script>--%>
<script src="../Scripts/tatreport/dataTables.buttons.min.new.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/jszip.min.new.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/pdfmake.min.new.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/vfs_fonts.new.js" language="javascript" type="text/javascript" ></script>
<script src="../Scripts/tatreport/buttons.html5.min.new.js" language="javascript" type="text/javascript" ></script>

<%--<script src="../Scripts/tatreport/datetimepicker_css.js" language="javascript" type="text/javascript" ></script>--%>
<script src="../Scripts/tatreport/ZeroClipboard.js" language="javascript" type="text/javascript" ></script>
              ...
              "fnStandingRedraw": function() { pop.show(); },
                    ...
                    "buttons": [
                                    ...
                                    },
                                    {
                                       ...
                                       // debugger;
                                            tst.defaultStyle.fontSize = 2;
                                            tst.pageOrientation = "landscape";
                                            tst.styles.tableFooter.fontSize = 2;
                                            tst.styles.tableHeader.fontSize = 2;                   
                                        }
                                    }
                          ]
                 //   "sDom": '<"H"Tfr>t<"F"ip>',
