...
<script src="../Scripts/TestStaticsReport/bootstrap.min.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/datetimepicker_css.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/jquery.dataTables.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/dataTables.tableTools.min.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/TableTools.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/TableTools.min.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/dataTables.bootstrap.js" language="javascript"
        type="text/javascript"></script>

    <%-- <script src="../Scripts/tatreport/jquery-ui.min.js" language="javascript" type="text/javascript" ></script>--%>

    <script src="../Scripts/TestStaticsReport/dataTables.buttons.min.new.js" language="javascript"
        type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/jszip.min.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/pdfmake.min.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/vfs_fonts.new.js" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/TestStaticsReport/buttons.html5.min.new.js" language="javascript"
        type="text/javascript"></script>

    <%--<script src="../Scripts/tatreport/datetimepicker_css.js" language="javascript" type="text/javascript" ></script>--%>

    <script src="../Scripts/TestStaticsReport/ZeroClipboard.js" language="javascript" type="text/javascript"></script>
