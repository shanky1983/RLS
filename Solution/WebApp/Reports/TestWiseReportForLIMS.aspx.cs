...
public partial class Reports_TestWiseReportForLIMS : BasePage
{
    ...
    string All = "All"; //Resources.Reports_ClientDisplay.Reports_CancelledBillReport_aspx_03 == null ? "All" : Resources.Reports_ClientDisplay.Reports_CancelledBillReport_aspx_03;
    ...
    private void LoadFeeType()
    {
        try
        {
            ...
            if (lstFTM.Count > 0)
            {
                ...
                ddlFeeType.DataBind();
                ddlFeeType.Items.Insert(0, All);
                ddlFeeType.Items[0].Value = "-1";
