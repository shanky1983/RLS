...
declare @ActionName nvarchar(500)='Approve Order'
declare @QueryString nvarchar(500)='../PurchaseOrder/PurchaseOrderQuantity.aspx?Approve=1&ID={IdentityValue}&GVPI={GridViewValue}&SupplierID={SupplierValue}&QuotationID={QuotationValue}'
declare @ActionCode nvarchar(500)='Approve_Order_PurchaseOrderQuantity'
declare @Pageid bigint
declare @pageurl nvarchar(500)='/PurchaseOrder/PurchaseOrderQuantity.aspx'
