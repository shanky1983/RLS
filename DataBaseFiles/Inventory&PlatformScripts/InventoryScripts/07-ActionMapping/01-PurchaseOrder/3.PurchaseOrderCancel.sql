...
declare @ActionName nvarchar(500)='Cancel Order'
declare @QueryString nvarchar(500)='../PurchaseOrder/ViewPurchaseOrder.aspx?can=1&ID={IdentityValue}&GVPI={GridViewValue}'
declare @ActionCode nvarchar(500)=' Cancel_Order_ViewPurchaseOrder'
