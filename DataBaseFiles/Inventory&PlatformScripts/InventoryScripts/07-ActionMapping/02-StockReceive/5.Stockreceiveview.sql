...
declare @QueryString nvarchar(500)='../Inventory/ViewStockReceived.aspx?ID={IdentityValue}&GVPI={GridViewValue}'
declare @ActionCode nvarchar(500)='View_Print_Order_ViewStockReceived'
declare @Pageid bigint
declare @pageurl nvarchar(500)='/StockReceived/ViewStockReceived.aspx'
declare @pagename nvarchar(500)='View Receive Stock'
declare @searchTypeID nvarchar(500)=(select SearchTypeID from SearchTypeMaster  where SearchTypeName='StockReceive')
