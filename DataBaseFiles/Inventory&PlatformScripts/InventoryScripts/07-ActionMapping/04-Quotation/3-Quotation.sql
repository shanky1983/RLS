...
declare @ActionName nvarchar(500)='Approve Quotation'
declare @QueryString nvarchar(500)='../Quotation/ProductSupplierRateMapping.aspx?QID={IdentityValue}&SID={SupplierValue}'
declare @ActionCode nvarchar(500)='ApproveQuotation'
declare @Pageid bigint
declare @pageurl nvarchar(500)='/Quotation/ProductSupplierRateMapping.aspx'
declare @pagename nvarchar(500)='Quotation Master'
