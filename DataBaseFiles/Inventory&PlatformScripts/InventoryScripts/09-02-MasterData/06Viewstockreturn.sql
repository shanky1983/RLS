...
declare @QueryString nvarchar(500)='../StockReturn/ViewStockReturn.aspx?ID={IdentityValue}&GVPI={GridViewValue}'
declare @ActionCode nvarchar(500)='View_Print_Order_ViewStockReturn'
declare @Pageid bigint
declare @pageurl nvarchar(500)='/StockReturn/ViewStockReturn.aspx'
declare @pagename nvarchar(500)='View Stock Return'
declare @searchTypeID nvarchar(500)=(select SearchTypeID from SearchTypeMaster  where SearchTypeName='StockReturn')
