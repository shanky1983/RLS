...
union select 'Home'
UNION select 'Inventory Location'
...
INNER JOIN PAGES PS ON PS.PAGEID=MM.PageID 
INNER JOIN Inventory_Pages IP ON IP.PageID=PS.PageID
INNER JOIN Role R on R.OrgID=MM.OrgId and R.RoleName =@RoleName
