...
{
    public class VisitOrderResult
    {
        public string OrderId { get; set; }
        public string OrgCode { get; set; }
        public string OverAllStatus { get; set; }
        public VisitResPatientDetails PatientInfo { get; set; }
        public VisitRePatientVisitDetails PatientVisitInfo { get; set; }
        public CorporatePatients CorporatePatient { get; set; }
        public List<TestOrder> OrderInfo { get; set; } 
    }
    public class VisitResPatientDetails
    {
    ...
    public class VisitRePatientVisitDetails
    {
   ...
   /* public class VisitResPatientVisitDetails
    {
        public string PatientVisitId { get; set; }
        public string ExternalVisitNumber { get; set; }
        public string VisitType { get; set; }
    ...
    public class VisitTestOrder
    {
        ...
        public List<VisitTestOrderContentVisit> OrderContentListInfo { get; set; }
        //public byte[] ResultAsPdf { get; set; }
    }
    public class VisitTestOrderContentVisit
    {
        public string TestCode { get; set; }
        public string OrderedDate { get; set; }
        public string TestType { get; set; }
    ...
    public class VisitTestOrderVisit
    {
        public string TestCode { get; set; }
        public string OrderedDate { get; set; }
        public string TestType { get; set; }
