        ...
        public ImageFile ScanPNG()
        {
            ...
            catch (COMException e)
            {
                ...
                if (errorCode ==  0x80210006)
                {
                     ...
                     CLogger.LogInfo("The scanner is busy or isn't ready");
                }else if(errorCode == 0x80210064)
                {
                     CLogger.LogInfo("The scanning process has been cancelled.");
                }else
                {
                     CLogger.LogInfo("A non catched error occurred, check the console");
                }
            }
