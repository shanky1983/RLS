...
Insert into Organization(OrgID,Name,OrganizationTypeID,AddressID,LogoPath)values(33,'
Julian Nursing Home',1,  0,'')
...
--Insert into Login(loginID,LoginName,Password,  IsLocked,OrgID,Status)values(1893,'TestAdmin1893','TestAdmin','N',32,  'A')
...
--Insert into Users(Name,SEX,TitleCode,OrgID,LoginID)  values('TestAdmin','M','1',32,1893)
...
Insert into Role(RoleID,RoleName,Description,ParentID,OrgID)  Values(200,'Lab Technician','Lab Technician',  0,33)--187
Insert into Role(RoleID,RoleName,Description,ParentID,OrgID)  Values(201,'Patient','Patient',  0,33)--188
Insert into Role(RoleID,RoleName,Description,ParentID,OrgID)  Values(202,'Receptionist','Receptionist',  0,33)--189
Insert into Role(RoleID,RoleName,Description,ParentID,OrgID)  Values(203,'Administrator','Administrator',  0,33)--190
Insert into Role(RoleID,RoleName,Description,ParentID,OrgID)  Values(204,'Dialysis Technician','Dialysis Technician',  0,33)--191
...
insert into Config(ConfigKey,ConfigValue,ParentID,OrgID)  values ('HEALTHPKG','Before',0,33)
...
insert into ReportOrgMapping (ReportID,RoleID,OrgID)values(42,203,33)
