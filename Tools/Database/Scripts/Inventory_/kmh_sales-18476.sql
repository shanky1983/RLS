...
--10236)  
 ...
 DELETE @Billdetails where PID in(
 SELECT t.PID FROM @Billdetails T inner join Patient P ON P.PatientID=T.PID where   
 P.PatientNumber in (521,
8342,
8420,
8421,
8422,
...
10236))  
 ...
 FROM @Billdetails T INNER JOIN StockInHand S ON S.ProductID=T.FeeID  and S.BatchNo=T.BatchNo         
  ...
  SELECT SUM(Qty*Rate) FROM @Billdetails
