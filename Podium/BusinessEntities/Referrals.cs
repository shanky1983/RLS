...
namespace Attune.Podium.BusinessEntities
{
	public class Referrals
	{
		...
		private DateTime referralDate=DateTime.MaxValue;
		...
		/// </summary>
		private int _referedToPhysicianID=0;
		...
		/// </summary>
		private string _referralNotes=String.Empty;
		...
		/// </summary>
		private string _referredOrganization=String.Empty;
