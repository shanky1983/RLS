...
{
	public class BillingDetails_HIST
	{
		#region Fields

		private long billingDetailsID_HIST=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the BillingDetailsID_HIST value.
		/// </summary>
		public long BillingDetailsID_HIST
		{
			get { return billingDetailsID_HIST; }
			set { billingDetailsID_HIST = value; }
		}
