...
namespace Attune.Podium.BusinessEntities
{
	public class StockReceived
	{
		...
		/// </summary>
		private Decimal _usedCreditAmount=Decimal.Zero;
		...
		/// </summary>
		private Decimal _grandTotalRF=Decimal.Zero;
		...
		/// </summary>
		private Decimal _packingSale=Decimal.Zero;
		public Decimal PackingSale
		{
			get { return  _packingSale; }
			set { _packingSale = value; }
		}

		/// <summary>
		/// Gets or sets the ExciseDuty value.
		/// </summary>
		private Decimal _exciseDuty=Decimal.Zero;
		public Decimal ExciseDuty
		{
			get { return  _exciseDuty; }
			set { _exciseDuty = value; }
		}

		/// <summary>
		/// Gets or sets the EduCess value.
		/// </summary>
		private Decimal _eduCess=Decimal.Zero;
		...
		/// </summary>
		private Decimal _secCess=Decimal.Zero;
		...
		/// </summary>
		private Decimal _cST=Decimal.Zero;
		public Decimal CST
		{
			get { return  _cST; }
			set { _cST = value; }
		...
		/// <summary>
		/// Gets or sets the AvialableCreditAmount value.
		/// </summary>
		private Decimal _avialableCreditAmount=Decimal.Zero;
		public Decimal AvialableCreditAmount
		{
			get { return  _avialableCreditAmount; }
			set { _avialableCreditAmount = value; }
		}
