...
namespace Attune.Podium.BusinessEntities
{
	public class ClientMaster
	{
		...
		private int printerPath=0;
        /*BEGIN || TAT || RAJKUMAR G || 20191001*/
		private byte tatprocessdatetype=0;
		private byte tattransitbasetype=0;
        /*END || TAT || RAJKUMAR G || 20191001*/
   private string reportLanguage = string.Empty;
    private int invoiceshowcolumns = 0;
	/* Franchisee changes by Surya*/
    private string isfranchisee = String.Empty;
    private string franchiseetype = String.Empty;
	/* Franchisee changes by Surya*/
		#endregion
		...
		/// <summary>
		/// Gets or sets the PrinterPath value.
		/// </summary>
		public int PrinterPath
		{
		...
		/// <summary>
		/// Gets or sets the Tatprocessdatetype value.
		/// </summary>
		public byte Tatprocessdatetype
		{
		...
		/// <summary>
		/// Gets or sets the Tattransitbasetype value.
		/// </summary>
		public byte Tattransitbasetype
		{
			get { return tattransitbasetype; }
			set { tattransitbasetype = value; }
		}

		/// <summary>
		/// Gets or sets the AddressDetails value.
		/// </summary>
		...
		/// </summary>
		private string _clientAttributes=String.Empty;
		public string ClientAttributes
		{
			get { return  _clientAttributes; }
			set { _clientAttributes = value; }
		}

		/// <summary>
		/// Gets or sets the ClientPayment value.
		/// </summary>
		private string _clientPayment=String.Empty;
		public string ClientPayment
		{
			get { return  _clientPayment; }
			set { _clientPayment = value; }
		}

		/// <summary>
		/// Gets or sets the DespatchMode value.
		/// </summary>
		private string _despatchMode=String.Empty;
		...
		/// <summary>
		/// Gets or sets the ParentClientName value.
		/// </summary>
		private string _parentClientName=String.Empty;
		public string ParentClientName
		{
			get { return  _parentClientName; }
			set { _parentClientName = value; }
		}
		...
		/// </summary>
		private string _collectionCenter=String.Empty;
		...
		/// <summary>
		/// Gets or sets the SalesManName value.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the HubName value.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the EmployeeContacts value.
		/// </summary>
		private string _employeeContacts=String.Empty;
		...
		/// <summary>
		/// Gets or sets the OtherContacts value.
		/// </summary>
		private string _otherContacts=String.Empty;
		...
		/// </summary>
		private string _childAttribute=String.Empty;
		...
		/// <summary>
		/// Gets or sets the ParentAttribute value.
		/// </summary>
		private string _parentAttribute=String.Empty;
		...
		/// <summary>
		/// Gets or sets the TodCode value.
		/// </summary>
		private string _todCode=String.Empty;
		...
		/// <summary>
		/// Gets or sets the TaxMaster value.
		/// </summary>
		private string _taxMaster=String.Empty;
		public string TaxMaster
		{
			get { return  _taxMaster; }
			set { _taxMaster = value; }
		}
		...
		/// <summary>
		/// Gets or sets the TodVol value.
		/// </summary>
		private string _todVol=String.Empty;
		public string TodVol
		{
			get { return  _todVol; }
			set { _todVol = value; }
		}
		...
		/// <summary>
		/// Gets or sets the ClientTaxDetails value.
		/// </summary>
		private string _clientTaxDetails=String.Empty;
		public string ClientTaxDetails
		{
			get { return  _clientTaxDetails; }
			set { _clientTaxDetails = value; }
		}

		/// <summary>
		/// Gets or sets the NotificationContacts value.
		/// </summary>
		private string _notificationContacts=String.Empty;
		public string NotificationContacts
		{
			get { return  _notificationContacts; }
			set { _notificationContacts = value; }
		}

		/// <summary>
		/// Gets or sets the PaymentCategory value.
		/// </summary>
		private string _paymentCategory=String.Empty;
		...
		/// <summary>
		/// Gets or sets the DiscountDeatils value.
		/// </summary>
		private string _discountDeatils=String.Empty;
		public string DiscountDeatils
		{
			get { return  _discountDeatils; }
			set { _discountDeatils = value; }
		}

		/// <summary>
		/// Gets or sets the OrderableLocation value.
		/// </summary>
		private string _orderableLocation=String.Empty;
		public string OrderableLocation
		{
			get { return  _orderableLocation; }
			set { _orderableLocation = value; }
		}

		/// <summary>
		/// Gets or sets the NotInvoiced value.
		/// </summary>
		private decimal _notInvoiced=Decimal.Zero;
		public decimal NotInvoiced
		{
			get { return  _notInvoiced; }
			set { _notInvoiced = value; }
		}

		/// <summary>
		/// Gets or sets the SAPDue value.
		/// </summary>
		private decimal _sAPDue=Decimal.Zero;
		public decimal SAPDue
		{
			get { return  _sAPDue; }
			set { _sAPDue = value; }
		}
		...
		/// <summary>
		/// Gets or sets the PendingCreditLimit value.
		/// </summary>
		private decimal _pendingCreditLimit=Decimal.Zero;
		public decimal PendingCreditLimit
		{
			get { return  _pendingCreditLimit; }
			set { _pendingCreditLimit = value; }
		}

		/// <summary>
		/// Gets or sets the CreditExpires value.
		/// </summary>
		private int _creditExpires=0;
		public int CreditExpires
		{
			get { return  _creditExpires; }
			set { _creditExpires = value; }
		}
		...
		public int InvoiceShowColumns
        {
            get { return invoiceshowcolumns; }
            set { invoiceshowcolumns = value; }
        }
		/* Frannchisee changes by Surya*/
        ...
        public string FranchiseeType
        {
            get { return franchiseetype; }
            set { franchiseetype = value; }
        }
/* Frannchisee changes by Surya*/
		#endregion
}
