...
{
	public class PatientMembershipCardMapping
	{
		#region Fields
		...
		/// </summary>
		private string _hasHealthCard=String.Empty;
		public string HasHealthCard
		{
			get { return  _hasHealthCard; }
			set { _hasHealthCard = value; }
		}

		/// <summary>
		/// Gets or sets the MyCardActiveDays value.
		/// </summary>
		private string _myCardActiveDays=String.Empty;
		public string MyCardActiveDays
		{
			get { return  _myCardActiveDays; }
			set { _myCardActiveDays = value; }
		}

		/// <summary>
		/// Gets or sets the MemebershipcardType value.
		/// </summary>
		private string _memebershipcardType=String.Empty;
		public string MemebershipcardType
		{
			get { return  _memebershipcardType; }
			set { _memebershipcardType = value; }
		}

		/// <summary>
		/// Gets or sets the HealthCardType value.
		/// </summary>
		private string _healthCardType=String.Empty;
		public string HealthCardType
		{
			get { return  _healthCardType; }
			set { _healthCardType = value; }
		}

		/// <summary>
		/// Gets or sets the CreditRedeemTye value.
		/// </summary>
		private string _creditRedeemTye=String.Empty;
		public string CreditRedeemTye
		{
			get { return  _creditRedeemTye; }
			set { _creditRedeemTye = value; }
		}
