...
{
	public class InvestigationOrgAttributesHistory
	{
		#region Fields
		...
		/// <summary>
		/// Gets or sets the IsNonFeed value.
		/// </summary>
		private string _isNonFeed=String.Empty;
		public string IsNonFeed
		{
			get { return  _isNonFeed; }
			set { _isNonFeed = value; }
		}
