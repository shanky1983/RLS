...
namespace Attune.Podium.BusinessEntities
{
    public class TestMaster
    {
        ...
        public string OutputGroupingCode { get; set; }
		public string IsSensitiveTest { get; set; }
        public string IsAutoCertification { get; set; }
        public bool ShowGroupInstruction { get; set; }
