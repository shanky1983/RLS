...
namespace Attune.Podium.BusinessEntities
{
	...
	public class Schedulesinvoice
    {
		...
		/// </summary>
		private string _approvalRequired=String.Empty;
		...
		/// </summary>
		private long _businessTypeID=0;
        ...
        private string _billofsupplynumber = String.Empty;
        public string BillofSupplyNumber
        {
            get { return _billofsupplynumber; }
            set { _billofsupplynumber = value; }
        }
