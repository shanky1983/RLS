...
{
	public class Edt_BillingDetails
	{
		#region Fields

		private long edt_BillingDetailsID=0;
		private long edtBillMasterID=0;
		private long edt_BillMasterDetailsID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the Edt_BillingDetailsID value.
		/// </summary>
		public long Edt_BillingDetailsID
		{
			get { return edt_BillingDetailsID; }
			set { edt_BillingDetailsID = value; }
		}
		...
		/// <summary>
		/// Gets or sets the Edt_BillMasterDetailsID value.
		/// </summary>
		public long Edt_BillMasterDetailsID
		{
			get { return edt_BillMasterDetailsID; }
			set { edt_BillMasterDetailsID = value; }
		}
