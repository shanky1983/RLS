...
{
	public class InvestigationLocationMapping
	{
		#region Fields
		...
		/// <summary>
		/// Gets or sets the ProcessingOrgName value.
		/// </summary>
		private string _processingOrgName=String.Empty;
		public string ProcessingOrgName
		{
			get { return  _processingOrgName; }
			set { _processingOrgName = value; }
		}
