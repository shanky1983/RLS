...
namespace Attune.Podium.BusinessEntities
{
	public class PatientPrescription
	{
		...
		/// </summary>
		private long _issueDrugID=0;
		public long IssueDrugID
		{
			get { return  _issueDrugID; }
			set { _issueDrugID = value; }
		}

		/// <summary>
		/// Gets or sets the IsGeneric value.
		/// </summary>
		private string _isGeneric=String.Empty;
		...
		/// </summary>
		private long _drugFrequencyID=0;
		...
		/// </summary>
		private int _drugInstructionID=0;
