...
{
	public class OrderedInvestigations
	{
		#region Fields
		...
		private int testSequenceOrder=0;
		private bool tatStatus=false;
		...
		{
			get { return testSequenceOrder; }
			set { testSequenceOrder = value; }
		}

		/// <summary>
		/// Gets or sets the TatStatus value.
		/// </summary>
		public bool TatStatus
		{
		...
		/// </summary>
		private long _referedToOrgID=0;
		public long ReferedToOrgID
		{
			get { return  _referedToOrgID; }
			set { _referedToOrgID = value; }
		}

		/// <summary>
		/// Gets or sets the ReferedToLocation value.
		/// </summary>
		private long _referedToLocation=0;
		public long ReferedToLocation
		{
			get { return  _referedToLocation; }
			set { _referedToLocation = value; }
		}
		...
		/// </summary>
		private string _printSeparately=String.Empty;
		public string PrintSeparately
		{
			get { return  _printSeparately; }
			set { _printSeparately = value; }
		}
		...
		/// </summary>
		private string _isbillable=String.Empty;
		...
		/// <summary>
		/// Gets or sets the CollectorComments value.
		/// </summary>
		private string _collectorComments=String.Empty;
		public string CollectorComments
		{
			get { return  _collectorComments; }
			set { _collectorComments = value; }
		}
		...
		/// <summary>
		/// Gets or sets the IsPreviousLabNumber value.
		/// </summary>
		private int _isPreviousLabNumber=0;
		public int IsPreviousLabNumber
		{
			get { return  _isPreviousLabNumber; }
			set { _isPreviousLabNumber = value; }
		}
        ...
        private Boolean _OutSourceFlag = false;
        public Boolean OutSourceFlag
        {
            get { return _OutSourceFlag; }
            set { _OutSourceFlag = value; }
        }
		#endregion
}
}
