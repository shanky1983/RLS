...
{
	public class HC_PatientInvSample
	{
		#region Fields
		...
		private int transferredRelationshipID=0;
		...
		/// <summary>
		/// Gets or sets the TransferredRelationshipID value.
		/// </summary>
		public int TransferredRelationshipID
		{
			get { return transferredRelationshipID; }
			set { transferredRelationshipID = value; }
		}
