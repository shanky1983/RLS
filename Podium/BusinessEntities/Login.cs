...
namespace Attune.Podium.BusinessEntities
{
	public class Login
	{
		...
		private int repliedMsgDaysConfig=0;
		private int oTPCount=0;
		private DateTime firstAccessedDTTM=DateTime.MaxValue;
		...
		/// <summary>
		/// Gets or sets the RepliedMsgDaysConfig value.
		/// </summary>
		public int RepliedMsgDaysConfig
		{
			get { return repliedMsgDaysConfig; }
			set { repliedMsgDaysConfig = value; }
		}

		/// <summary>
		/// Gets or sets the OTPCount value.
		/// </summary>
		public int OTPCount
		{
			get { return oTPCount; }
		...
		/// <summary>
		/// Gets or sets the FirstAccessedDTTM value.
		/// </summary>
		public DateTime FirstAccessedDTTM
		{
			get { return firstAccessedDTTM; }
			set { firstAccessedDTTM = value; }
		}
		...
		/// </summary>
		private string _authorizerQualification=String.Empty;
		public string AuthorizerQualification
		{
			get { return  _authorizerQualification; }
			set { _authorizerQualification = value; }
		}

		/// <summary>
		/// Gets or sets the AuthorizerSignature value.
		/// </summary>
		private byte _authorizerSignature=new byte();
		public byte AuthorizerSignature
		{
			get { return  _authorizerSignature; }
			set { _authorizerSignature = value; }
		}
