...
namespace Attune.Podium.BusinessEntities
{
	public class UserAddress
	{
		...
		/// </summary>
		private int _cutOffTimeValue=0;
		public int CutOffTimeValue
		{
			get { return  _cutOffTimeValue; }
			set { _cutOffTimeValue = value; }
		}

		/// <summary>
		/// Gets or sets the CutOffTimeType value.
		/// </summary>
		private string _cutOffTimeType=String.Empty;
		public string CutOffTimeType
		{
			get { return  _cutOffTimeType; }
			set { _cutOffTimeType = value; }
		}
