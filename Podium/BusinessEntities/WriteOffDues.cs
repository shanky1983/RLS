...
{
	public class WriteOffDues
	{
		#region Fields

		private long writeOffDuesID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the WriteOffDuesID value.
		/// </summary>
		public long WriteOffDuesID
		{
			get { return writeOffDuesID; }
			set { writeOffDuesID = value; }
		}
