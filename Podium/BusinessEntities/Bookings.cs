...
namespace Attune.Podium.BusinessEntities
{
	public class Bookings
	{
		...
		/// <summary>
		/// Gets or sets the RescheduleToken value.
		/// </summary>
		public int RescheduleToken
		{
			get { return rescheduleToken; }
			set { rescheduleToken = value; }
		}
		...
		/// <summary>
		/// Gets or sets the SchedulableResource value.
		/// </summary>
		List<SchedulableResource> _schedulableresource;
		public List<SchedulableResource> SchedulableResource
		{
			get { return _schedulableresource; }
			set { _schedulableresource = value; }
		}
		...
		/// <summary>
		/// Gets or sets the OtherOrgID value.
		/// </summary>
		private int _otherOrgID=0;
		public int OtherOrgID
		{
			get { return  _otherOrgID; }
			set { _otherOrgID = value; }
		}
