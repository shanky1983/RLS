...
namespace Attune.Podium.BusinessEntities
{
	public class InvSampleMaster
	{
		...
		private string isSpecialSample=String.Empty;
		...
		/// <summary>
		/// Gets or sets the IsSpecialSample value.
		/// </summary>
		public string IsSpecialSample
		{
			get { return isSpecialSample; }
			set { isSpecialSample = value; }
		}
