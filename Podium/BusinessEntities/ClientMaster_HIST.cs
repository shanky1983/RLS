...
{
	public class ClientMaster_HIST
	{
		#region Fields

		private long client_HistoryID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the Client_HistoryID value.
		/// </summary>
		public long Client_HistoryID
		{
			get { return client_HistoryID; }
			set { client_HistoryID = value; }
		}
		...
		/// <summary>
		/// Gets or sets the AuthorizedRole value.
		/// </summary>
		private string _authorizedRole=String.Empty;
		public string AuthorizedRole
		{
			get { return  _authorizedRole; }
			set { _authorizedRole = value; }
		}

		/// <summary>
		/// Gets or sets the ModifedPerson value.
		/// </summary>
		private string _modifedPerson=String.Empty;
		public string ModifedPerson
		{
			get { return  _modifedPerson; }
			set { _modifedPerson = value; }
		}
