...
{
	public class Login_HIST
	{
		#region Fields

		private long loginID_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the LoginID_HISTID value.
		/// </summary>
		public long LoginID_HISTID
		{
			get { return loginID_HISTID; }
			set { loginID_HISTID = value; }
		}
