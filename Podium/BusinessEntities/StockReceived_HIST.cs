...
{
	public class StockReceived_HIST
	{
		#region Fields

		private long stockReceived_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the StockReceived_HISTID value.
		/// </summary>
		public long StockReceived_HISTID
		{
			get { return stockReceived_HISTID; }
			set { stockReceived_HISTID = value; }
		}
