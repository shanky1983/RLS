...
{
	public class CRPT_GRP
	{
		#region Fields

		private string lAB=String.Empty;
		private string gROUPNAME=String.Empty;
		private float attuneGRPID=0.0F;
		...
		/// <summary>
		/// Gets or sets the AttuneGRPID value.
		/// </summary>
		public float AttuneGRPID
		{
			get { return attuneGRPID; }
			set { attuneGRPID = value; }
		}
