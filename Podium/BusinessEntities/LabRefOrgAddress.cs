...
namespace Attune.Podium.BusinessEntities
{
	public class LabRefOrgAddress
	{
		...
		private string altLandLineNumber=String.Empty;
		...
		/// <summary>
		/// Gets or sets the AltLandLineNumber value.
		/// </summary>
		public string AltLandLineNumber
		{
			get { return altLandLineNumber; }
			set { altLandLineNumber = value; }
		}
