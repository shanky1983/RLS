...
namespace Attune.Podium.BusinessEntities
{
	public class LocationUserMap
	{
		...
		private long locationUserMapID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the LocationUserMapID value.
		/// </summary>
		public long LocationUserMapID
		{
			get { return locationUserMapID; }
			set { locationUserMapID = value; }
		}
		...
		/// </summary>
		private int _parentLocationID=0;
