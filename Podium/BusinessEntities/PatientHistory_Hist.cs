...
{
	public class PatientHistory_Hist
	{
		#region Fields

		private long patientHist_HistID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the PatientHist_HistID value.
		/// </summary>
		public long PatientHist_HistID
		{
			get { return patientHist_HistID; }
			set { patientHist_HistID = value; }
		}
