...
{
	public class PatientVisit_HIST
	{
		#region Fields

		private long patientVisitId_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the PatientVisitId_HISTID value.
		/// </summary>
		public long PatientVisitId_HISTID
		{
			get { return patientVisitId_HISTID; }
			set { patientVisitId_HISTID = value; }
		}
