...
{
	public class HC_VisitClientMapping
	{
		#region Fields
		...
		private DateTime clientSwapDate=DateTime.MaxValue;
		...
		/// <summary>
		/// Gets or sets the ClientSwapDate value.
		/// </summary>
		public DateTime ClientSwapDate
		{
			get { return clientSwapDate; }
			set { clientSwapDate = value; }
		}
