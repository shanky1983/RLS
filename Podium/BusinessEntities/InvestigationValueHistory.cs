...
{
	public class InvestigationValueHistory
	{
		#region Fields

		private long invValuesHistoryID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the InvValuesHistoryID value.
		/// </summary>
		public long InvValuesHistoryID
		{
			get { return invValuesHistoryID; }
			set { invValuesHistoryID = value; }
		}
		...
		/// <summary>
		/// Gets or sets the CurrentValues value.
		/// </summary>
