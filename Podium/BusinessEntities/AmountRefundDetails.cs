...
{
	public class AmountRefundDetails
	{
		#region Fields
		...
		private decimal cancelAmount=Decimal.Zero;
		private decimal refundadjustedAmt=Decimal.Zero;
		private decimal discountAdjustedAmt=Decimal.Zero;
		private decimal redeemAdjustedAmt=Decimal.Zero;
		...
		/// <summary>
		/// Gets or sets the CancelAmount value.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the RefundadjustedAmt value.
		/// </summary>
		public decimal RefundadjustedAmt
		{
			get { return refundadjustedAmt; }
			set { refundadjustedAmt = value; }
		}

		/// <summary>
		/// Gets or sets the DiscountAdjustedAmt value.
		/// </summary>
		public decimal DiscountAdjustedAmt
		{
			get { return discountAdjustedAmt; }
			set { discountAdjustedAmt = value; }
		}

		/// <summary>
		/// Gets or sets the RedeemAdjustedAmt value.
		/// </summary>
		public decimal RedeemAdjustedAmt
		{
			get { return redeemAdjustedAmt; }
			set { redeemAdjustedAmt = value; }
		}
		...
		/// <summary>
		/// Gets or sets the BaseCurrencyName value.
		/// </summary>
		private string _baseCurrencyName=String.Empty;
		...
		/// <summary>
		/// Gets or sets the TranCurrencyName value.
		/// </summary>
		private string _tranCurrencyName=String.Empty;
		public string TranCurrencyName
		{
			get { return  _tranCurrencyName; }
			set { _tranCurrencyName = value; }
		}
		...
		/// </summary>
		private decimal _approvedAmt=Decimal.Zero;
		...
		/// <summary>
		/// Gets or sets the RefundRoundOFF value.
		/// </summary>
		private decimal _refundRoundOFF=Decimal.Zero;
		public decimal RefundRoundOFF
		{
			get { return  _refundRoundOFF; }
			set { _refundRoundOFF = value; }
		}
