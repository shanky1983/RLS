...
{
	public class PatientDiagnosticsAttribute
	{
		#region Fields

		private long patientDiagnosticsAttributeID=0;
		private long patientVisitID=0;
		private long diagnosticsID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the PatientDiagnosticsAttributeID value.
		/// </summary>
		public long PatientDiagnosticsAttributeID
		{
			get { return patientDiagnosticsAttributeID; }
			set { patientDiagnosticsAttributeID = value; }
		}
		...
		/// </summary>
		private string _diagnosticsName=String.Empty;
		public string DiagnosticsName
		{
			get { return  _diagnosticsName; }
			set { _diagnosticsName = value; }
		}
