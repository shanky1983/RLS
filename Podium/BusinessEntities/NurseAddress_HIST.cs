...
{
	public class NurseAddress_HIST
	{
		#region Fields

		private long nurseAddress_HISTID=0;
		...
		#region Properties
		/// <summary>
		/// Gets or sets the NurseAddress_HISTID value.
		/// </summary>
		public long NurseAddress_HISTID
		{
			get { return nurseAddress_HISTID; }
			set { nurseAddress_HISTID = value; }
		}
