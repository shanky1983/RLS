...
namespace Attune.Podium.BusinessEntities
{
	public class InvStatusOrgPageMapping
	{
		...
		private int invStatusOrgPageMappingID=0;
		...
		/// <summary>
		/// Gets or sets the InvStatusOrgPageMappingID value.
		/// </summary>
		public int InvStatusOrgPageMappingID
		{
			get { return invStatusOrgPageMappingID; }
			set { invStatusOrgPageMappingID = value; }
		}
