...
namespace Attune.Podium.BusinessEntities
{
	public class Invoice
	{
		...
		/// </summary>
		private Decimal _discountAmt=Decimal.Zero;
		...
		/// <summary>
		/// Gets or sets the SaPLabCode value.
		/// </summary>
		private string _saPLabCode=String.Empty;
		public string SaPLabCode
		{
			get { return  _saPLabCode; }
			set { _saPLabCode = value; }
		}
		...
		/// </summary>
		private string _billedDate=String.Empty;
